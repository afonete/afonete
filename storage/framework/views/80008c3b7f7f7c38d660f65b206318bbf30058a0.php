...
<div class="content-wrapper text-white" style="background:#1c1d20;">
    ...
    <div class="tabs tab_links my-2" style="border-bottom: 1px solid white">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('user.deposits.history')); ?>" class="btn btn-sm btn-outline-light font-weight-bold">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3 border-bottom pb-3" style="border-color: rgba(255,255,255,0.1) !important;">
                        <div>
                            <span class="badge badge-warning text-dark font-weight-bold px-3 py-1 text-uppercase" id="dashPendingBadge" style="font-size: 0.8rem; border-radius: 6px;">
                                <?php echo e($pendingIsExpired ? 'EXPIRED' : 'PENDING APPROVAL'); ?>
                            ...
                            <small class="text-light opacity-80">Reference: <strong><?php echo e($pendingDeposit->transaction_id); ?></strong></small>
                        </div>
                        <div class="text-center bg-dark p-3 rounded border border-warning" style="min-width: 180px; border-radius: 10px !important;">
                            ...
                            <div id="dashCountdown" class="font-mono font-weight-bold text-warning" style="font-size: 2.2rem; line-height: 1;">
                                <?php echo e($pendingSecs !== null ? gmdate('i:s', $pendingSecs) : '15:00'); ?>
                        ...
                        <div class="col-md-8 mb-2 mb-md-0">
                            <div class="row text-sm">
                                <div class="col-6 col-sm-3 mb-2">
                                    ...
                                    <strong class="text-warning" style="font-size: 1.1rem;">$<?php echo e(number_format($pendingDeposit->amount_deposited, 2)); ?></strong>
                                </div>
                                <div class="col-6 col-sm-3 mb-2">
                                    <span class="text-muted d-block small">METHOD</span>
                                    <strong><?php echo e($pendingDeposit->deposit_method ?? 'MANUAL'); ?></strong>
                                </div>
                                <div class="col-6 col-sm-3 mb-2">
                                    <span class="text-muted d-block small">SUBMITTED</span>
                                    <strong><?php echo e($pendingDeposit->created_at->format('M d, H:i')); ?></strong>
                                </div>
                                <div class="col-6 col-sm-3 mb-2">
                                    <span class="text-muted d-block small">NETWORK</span>
                                    <strong><?php echo e($pendingDeposit->network ?? 'TRC-20'); ?></strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-md-right">
                            <a href="<?php echo e(route('user.manual-deposit.waiting', $pendingDeposit->id)); ?>" class="btn btn-warning font-weight-bold px-3 py-2" style="border-radius: 8px;">
        ...
        <script>
        (function(){
            var expiresAt = <?php echo json_encode($pendingExpiresAtIso, 15, 512) ?>;
            var statusUrl = <?php echo json_encode(route('user.manual-deposit.status', $pendingDeposit->id), 512) ?>;
