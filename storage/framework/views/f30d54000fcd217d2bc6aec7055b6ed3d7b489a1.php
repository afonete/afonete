                ...
                <div class="faq-accordion">
                    <div class="faq-item mb-3">
                        <div class="faq-question" onclick="toggleFaq('faq1', this)">
                            <span class="question-text">What are <?php echo e((env('APP_NAME'))); ?>?</span>
                    ...
                    <div class="faq-item mb-3">
                        <div class="faq-question" onclick="toggleFaq('faq3', this)">
                            <span class="question-text"><?php echo e((env('APP_NAME'))); ?> Free to use ?</span>
                            <i class="fas fa-plus icon-toggle"></i>
                        </div>
                    ...
                    <div class="faq-item mb-3">
                        ...
                        <div id="faq6" class="faq-answer collapse">
                            ...
                            <ul>
                                <li>Tell friend, classmate, neighbor, acquaintance and business partners about <?php echo e((env('APP_NAME'))); ?> .</li>
                    ...
                    <div class="faq-item mb-3">
                        ...
                        <div id="faq7" class="faq-answer collapse">
                            <!-- <hr class="divider"> -->
                            <div class="answer-content">
                            Yes, <?php echo e((env('APP_NAME'))); ?> believes in total transparency and offers all data to the users like username, total refer team and
                    ...
                    <div class="faq-item mb-3">
                        <div class="faq-question" onclick="toggleFaq('faq8', this)">
                            <span class="question-text"> Does  <?php echo e((env('APP_NAME'))); ?>  have a referral program ?</span>
                            <i class="fas fa-plus icon-toggle"></i>
                        </div>
                    ...
                    <div class="faq-item mb-3">
                        <div class="faq-question" onclick="toggleFaq('faq12', this)">
                            <span class="question-text">Is <?php echo e((env('APP_NAME'))); ?> supported in  my country ?</span>
                            <i class="fas fa-plus icon-toggle"></i>
                        </div>
                        <div id="faq12" class="faq-answer collapse">
                            <!-- <hr class="divider"> -->
                            <div class="answer-content">
                            <?php echo e((env('APP_NAME'))); ?> is available worldwide and open to all users. We have users from every country around the world! Some
...
<?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/user/faq.blade.php ENDPATH**/ ?>