    ...
    <div class="container-fluid py-4 max-w-7xl mx-auto">
        ...
        <div class="alert alert-dark d-flex align-items-center justify-content-between flex-wrap gap-3 p-4 mb-4 text-white shadow-sm" style="border-radius: 14px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border: 1px solid rgba(168, 85, 247, 0.4);">
            ...
            <div class="bg-dark px-3.5 py-2 rounded text-right border border-purple shadow-sm" style="border-radius: 10px !important; border-color: #a855f7 !important;">
                ...
                <strong class="text-white font-mono" style="font-size: 1.25rem; letter-spacing: 1px;"><?php echo e($symbol); ?></strong>
            </div>
        </div>
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger mt-2 shadow-sm d-flex align-items-center justify-content-between" style="border-radius: 10px;">
                <span><i class="fas fa-exclamation-triangle mr-2"></i> <?php echo e(session('error')); ?></span>
            </div>
        <?php endif; ?>

        <?php if($errors->any()): ?>
            <div class="alert alert-danger mt-2 shadow-sm" style="border-radius: 10px;"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
        ...
        <div class="row mb-4">
            <div class="col-12 col-md-6 mb-3 mb-md-0">
                <div class="card shadow-sm border-0 h-100 p-4 bg-white" style="border-radius: 14px; border-left: 5px solid #8b5cf6 !important;">
                    ...
                    <h2 class="font-weight-bold text-dark my-1" style="font-size: 2rem;">$<?php echo e(number_format($tradingBal, 2)); ?></h2>
            ...
            <div class="col-12 col-md-6">
                <div class="card shadow-sm border-0 h-100 p-4 bg-white" style="border-radius: 14px; border-left: 5px solid #10b981 !important;">
                    ...
                    <h2 class="font-weight-bold text-dark my-1" style="font-size: 2rem;"><?php echo e(number_format($availableTokenBal, 2)); ?> <small class="text-muted font-weight-bold" style="font-size: 1.1rem;"><?php echo e($symbol); ?></small></h2>
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 14px; overflow: hidden;">
            <div class="card-header bg-white p-3.5 border-bottom d-flex align-items-center justify-content-between">
                ...
                <span class="badge badge-dark px-3 py-1 font-mono" style="font-size: 11px;">USD &rarr; <?php echo e($symbol); ?></span>
            </div>
                    ...
                    <div class="col-md-6 mb-4 mb-md-0">
                        <div class="p-4 rounded-2xl shadow-sm h-100" style="border-radius: 12px; border: 1px solid #e2e8f0; background-color: #f8fafc;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge badge-primary px-3 py-1 font-weight-bold" style="font-size: 0.75rem;">$<?php echo e(number_format($swapPrice, 4)); ?> / token</span>
                            </div>
                            ...
                            <form method="POST" action="<?php echo e(route('user.internal-exchange.trading-action')); ?>" class="js-transaction-password-form">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="amount" id="swapAmountInput" onkeyup="calcTokens('swap')" min="0.01" step="0.01" max="<?php echo e($tradingBal); ?>" required placeholder="Available Trading: $<?php echo e(number_format($tradingBal, 2)); ?>" class="form-control font-weight-bold" style="border-radius: 8px 0 0 8px;">
                                ...
                                <div class="p-3 bg-white rounded border mb-3 small shadow-sm">
                                    ...
                                    <strong id="swapTokenResult" class="text-primary font-weight-bold font-mono" style="font-size: 1.2rem;">0.00 <?php echo e($symbol); ?></strong>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="p-4 rounded-2xl shadow-sm h-100" style="border-radius: 12px; border: 1px solid #e2e8f0; background-color: #f8fafc;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="badge badge-success px-3 py-1 font-weight-bold" style="font-size: 0.75rem;">$<?php echo e(number_format($tradingPrice, 4)); ?> / token</span>
                            </div>
                            ...
                            <form method="POST" action="<?php echo e(route('user.internal-exchange.trading-action')); ?>" class="js-transaction-password-form">
                                ...
                                <div class="form-group mb-3">
                                    <label class="font-weight-bold text-dark small">Trading USD Amount ($)</label>
                                    <div class="input-group">
                                        <input type="number" name="amount" id="buyAmountInput" onkeyup="calcTokens('buy')" min="0.01" step="0.01" max="<?php echo e($tradingBal); ?>" required placeholder="Available Trading: $<?php echo e(number_format($tradingBal, 2)); ?>" class="form-control font-weight-bold" style="border-radius: 8px 0 0 8px;">
                                        <div class="input-group-append">
                                            <span class="input-group-text font-weight-bold bg-dark text-white" style="border-radius: 0 8px 8px 0;">USD</span>
                                        </div>
                                    </div>
                                ...
                                <div class="p-3 bg-white rounded border mb-3 small shadow-sm">
                                    <span class="text-muted d-block font-weight-bold mb-1">Tokens to Receive:</span>
                                    <strong id="buyTokenResult" class="text-success font-weight-bold font-mono" style="font-size: 1.2rem;">0.00 <?php echo e($symbol); ?></strong>
                                </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0 text-dark" style="font-size: 0.85rem;">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <tr>
                                    <td class="py-3 px-3 font-weight-bold text-muted"><?php echo e(($transactions->currentPage() - 1) * $transactions->perPage() + $loop->iteration); ?></td>
                                    <td class="py-3 px-3"><strong class="font-mono text-dark"><?php echo e($t->transaction_no); ?></strong></td>
                                    <td class="py-3 px-3">
                                        <?php if($t->transaction_type === 'TOKEN_SWAP'): ?>
                                            <span class="badge badge-primary px-2.5 py-1" style="font-size: 10px;">SWAP</span>
                                        <?php elseif($t->transaction_type === 'TOKEN_PURCHASE'): ?>
                                            <span class="badge badge-success px-2.5 py-1" style="font-size: 10px;">PURCHASE</span>
                                        <?php else: ?>
                                            <span class="badge badge-dark px-2.5 py-1" style="font-size: 10px;"><?php echo e($t->transaction_type); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-3 px-3 font-weight-bold">
                                        <?php if($t->transaction_type === 'TOKEN_SWAP'): ?>
                                            Swapped <strong>$<?php echo e(number_format($usdAmt, 2)); ?> USD</strong> from Trading Wallet for <strong><?php echo e(number_format($tokens, 2)); ?> <?php echo e($symbol); ?></strong> (Rate: $<?php echo e(number_format($rate, 4)); ?>/token)
                                        <?php elseif($t->transaction_type === 'TOKEN_PURCHASE'): ?>
                                            Purchased <strong><?php echo e(number_format($tokens, 2)); ?> <?php echo e($symbol); ?></strong> for <strong>$<?php echo e(number_format($usdAmt, 2)); ?> USD</strong> from Trading Wallet (Rate: $<?php echo e(number_format($rate, 4)); ?>/token)
                                        <?php else: ?>
                                            <?php echo e($t->transaction_details); ?>

                                        <?php endif; ?>
                                    </td>
                                    <td class="py-3 px-3 text-right font-mono text-muted"><small><?php echo e($t->created_at ? $t->created_at->format('Y-m-d H:i') : '—'); ?></small></td>
                                </tr>
