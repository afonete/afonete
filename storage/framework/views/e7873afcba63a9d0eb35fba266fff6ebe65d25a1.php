        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-8 text-center text-white">
                    ...
                    <h2 class="text-xl font-extrabold"><?php echo e(($user && !empty($user->name)) ? $user->name : ($leader->Names ?: $leader->User_name)); ?></h2>
                    <p class="text-blue-100 text-sm font-mono mt-1">&#64;<?php echo e($leader->User_name); ?></p>
                </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="pt-3 border-t">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <?php if(($leader->leadership_level ?? 'TEAM_LEADER') === 'SUPER_LEADER' || $credit): ?>
                            <form action="<?php echo e(route('admin.team-leaders.revoke-credit', $leader->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('admin.team-leaders.convert-to-free', $leader->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <?php elseif($leader->status === 'confirmed'): ?>
                        ...
                        <?php if(isset($activeUvpAmount) && $activeUvpAmount > 0): ?>
                            <div class="bg-amber-50 border border-amber-300 rounded-xl p-3.5 mb-4 text-xs text-amber-900 font-bold flex items-start gap-2.5 shadow-sm">
                                ...
                                <div>
                                    ...
                                    This leader holds an active UVP Package worth <strong>$<?php echo e(number_format($activeUvpAmount, 2)); ?></strong>. Converting them to a free user will revoke leader privileges, but their UVP investment will remain active.
                                </div>
                            </div>
                        <?php endif; ?>

                        <div class="flex flex-wrap gap-3">
                            <form action="<?php echo e(route('admin.team-leaders.suspend', $leader->id)); ?>" method="POST" class="flex-1">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                            ...
                            <form action="<?php echo e(route('admin.team-leaders.convert-to-free', $leader->id)); ?>" method="POST" class="flex-1">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                                        ...
                                        onclick="return confirm('WARNING: This leader holds an active UVP Package worth $<?php echo e(number_format($activeUvpAmount ?? 0, 2)); ?>. Are you sure you want to convert them to a Free Standard User? All leader credits will be revoked.');">
