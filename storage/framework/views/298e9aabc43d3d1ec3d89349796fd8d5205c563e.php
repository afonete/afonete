...
<div class="wrap">
    <div class="top">
        ...
        <div>
            <a class="btn btn-dark" href="<?php echo e(route('user.venture')); ?>">Back to UVP</a>
            <a class="btn btn-dark" href="<?php echo e(route('user.package')); ?>">Back to FC</a>
        </div>
    </div>

    <?php if(session('message')): ?> <div class="alert success"><?php echo e(session('message')); ?></div> <?php endif; ?>
    ...
    <?php if($pendingDeposit): ?>
        <div class="alert info">
            You already have a pending manual deposit request: <strong><?php echo e($pendingDeposit->transaction_id); ?></strong>.
            <a href="<?php echo e(route('user.manual-deposit.waiting', $pendingDeposit->id)); ?>" style="color:#fff; text-decoration:underline; font-weight:700;">Open waiting page</a>
        </div>
    <?php endif; ?>
    ...
    <?php else: ?>
    <form method="POST" action="<?php echo e(route('user.manual-deposit.submit')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="grid">
            <div class="card">
                <div class="card-h">
                ...
                <div class="card-b">
                        ...
                        <select name="wallet_id" id="wallet_id" required>
                            ...
                            <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($wallet->id); ?>"
                                        ...
                                        data-type="<?php echo e($wallet->kindLabel()); ?>"
                                        data-label="<?php echo e($wallet->label); ?>"
                                        data-network="<?php echo e($wallet->network); ?>"
                                        data-currency="<?php echo e($wallet->currency); ?>"
                                        data-address="<?php echo e($wallet->wallet_address); ?>"
                                        data-min="<?php echo e($wallet->min_amount); ?>"
                                        data-max="<?php echo e($wallet->max_amount); ?>"
                                        data-qr="<?php echo e($wallet->qrImageUrl(220)); ?>"
                                        data-instructions="<?php echo e($wallet->instructions ?: $wallet->notes ?: ''); ?>">
                                    <?php echo e($wallet->kindLabel()); ?> — <?php echo e($wallet->label ?: $wallet->currency); ?> <?php echo e($wallet->network ? '(' . $wallet->network . ')' : ''); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="number" id="amount" name="amount" min="<?php echo e($minDeposit); ?>" step="0.01" required placeholder="Minimum $<?php echo e(number_format($minDeposit, 2)); ?>" value="<?php echo e(old('amount')); ?>">
                    </div>

                    <div class="field">
                        <label for="paymentaccount">Wallet/account you paid from</label>
                        <input type="text" id="paymentaccount" name="paymentaccount" required placeholder="Sender wallet address / Advcash / Perfect Money account" value="<?php echo e(old('paymentaccount')); ?>">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/manual-deposit.blade.php ENDPATH**/ ?>