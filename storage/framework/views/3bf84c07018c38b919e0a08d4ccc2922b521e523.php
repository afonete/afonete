            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <p class="about-par"><?php echo e(strtoupper(env('APP_NAME'))); ?> is bridges connects	the gap between traditional marketing , innovate technology and the digital marketing in
...
.</p>
 ...
 <div class="breadcrumb-text"> <h3 style="font-family: Arial, Helvetica, sans-serif;">WHAT IS <?php echo e(strtoupper(env('APP_NAME'))); ?></h3> </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="breadcrumb-text pt-5" style="">
                            ...
                            <p class="about-par">
                            <?php echo e(strtoupper(env('APP_NAME'))); ?>  is a unique innovative next generation referral program platform solutions, connecting three great communities t
                    ...
                    <div >
                        <div class="ap-title my-5">
                            <h3 style="color: #707079; font-size: 18px; text-align: center"><?php echo e(strtoupper(env('APP_NAME'))); ?>  have created a unique solutions system for global community of people who love innovative technologies, blockchain technologies
...
<?php echo $__env->make('home.include.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 </div><?php /**PATH C:\xampp\htdocs\KANANI\BIFONEX\mcu.focoin.eu\resources\views/home/about.blade.php ENDPATH**/ ?>