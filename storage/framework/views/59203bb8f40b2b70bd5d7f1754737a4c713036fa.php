            ...
            <div class="leader-container">
                ...
                <?php if(session('success')): ?>
                    <div class="alert alert-success alert-dismissible fade show border-0 mb-4" style="border-radius: 8px; background-color: #0f5132; color: #d1e7dd;">
                        <i class="fas fa-check-circle mr-2"></i><strong>Success!</strong> <?php echo e(session('success')); ?>
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger alert-dismissible fade show border-0 mb-4" style="border-radius: 8px; background-color: #842029; color: #f8d7da;">
                        <i class="fas fa-exclamation-triangle mr-2"></i><strong>Error!</strong> <?php echo e(session('error')); ?>
                ...
                <div class="leader-header mb-4" style="border-color: #f59e0b; background: linear-gradient(135deg, #1c1d20 0%, #2d2006 100%);">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <div class="text-right">
                            <h3 class="mb-0 font-weight-extrabold" style="color: #fbbf24;">$<?php echo e(number_format($credit->credit_amount, 2)); ?></h3>
                    ...
                    <div class="row mt-3 pt-3" style="border-top: 1px solid #2e2f34;">
                        <div class="col-4 text-center">
                            ...
                            <p class="font-weight-bold text-success mb-0">$<?php echo e(number_format($credit->remaining_credit, 2)); ?></p>
                        </div>
                        <div class="col-4 text-center">
                            <p class="text-slate-500 text-xs mb-1">Cashout</p>
                            <p class="font-weight-bold text-info mb-0">$<?php echo e(number_format($credit->cashout_amount, 2)); ?></p>
                        </div>
                        <div class="col-4 text-center">
                            <p class="text-slate-500 text-xs mb-1">Turnover Target</p>
                            <p class="font-weight-bold text-white mb-0">$<?php echo e(number_format($credit->sales_turnover_target, 2)); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>

                <?php $activeTab = request('tab', 'planning'); ?>

                
                <ul class="nav nav-pills mb-4 leader-tabs-nav" id="leaderTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($activeTab === 'planning' ? 'active' : ''); ?>" id="tab-planning-link" data-toggle="pill" href="#tab-planning" role="tab">
                            <i class="fas fa-calendar-plus mr-1.5"></i>Page 1: Events Planning &amp; Zoom
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($activeTab === 'proof' ? 'active' : ''); ?>" id="tab-proof-link" data-toggle="pill" href="#tab-proof" role="tab">
                            <i class="fas fa-camera-retro mr-1.5"></i>Page 2: Event Proof Upload
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($activeTab === 'ambassador' ? 'active' : ''); ?>" id="tab-ambassador-link" data-toggle="pill" href="#tab-ambassador" role="tab">
                            <i class="fas fa-bullhorn mr-1.5"></i>Page 3: Social Ambassador Link
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($activeTab === 'videos' ? 'active' : ''); ?>" id="tab-videos-link" data-toggle="pill" href="#tab-videos" role="tab">
                            <i class="fas fa-video mr-1.5"></i>Page 4: Official Videos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($activeTab === 'banners' ? 'active' : ''); ?>" id="tab-banners-link" data-toggle="pill" href="#tab-banners" role="tab">
                ...
                <div class="tab-content" id="leaderTabsContent">
                    ...
                    <div class="tab-pane fade <?php echo e($activeTab === 'planning' ? 'show active' : ''); ?>" id="tab-planning" role="tabpanel">
                        <div class="row">
                            
                            <div class="col-lg-5 mb-4">
                                <div class="leader-card">
                                    <h5 class="font-weight-bold mb-3 text-info"><i class="fas fa-calendar-plus mr-2"></i>Schedule a New Event</h5>
                                    <form action="<?php echo e(route('team-leader.events.store')); ?>" method="POST" class="space-y-3">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table table-dark-custom mb-0">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        <td class="font-weight-bold text-light"><?php echo e($event->title); ?></td>
                                                        <td>
                                                            <?php if($event->type === 'zoom'): ?>
                                                                <span class="badge badge-primary px-2.5 py-1 text-xs">Zoom</span>
                                                                <small class="text-muted d-block mt-1 font-mono truncate max-w-[150px]"><a href="<?php echo e($event->zoom_link); ?>" target="_blank" class="text-info"><?php echo e($event->zoom_link); ?></a></small>
                                                            <?php else: ?>
                                                                <span class="badge badge-info px-2.5 py-1 text-xs">Physical</span>
                                                                <small class="text-muted d-block mt-1 truncate max-w-[150px]" title="<?php echo e($event->location); ?>"><?php echo e($event->location); ?></small>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td class="text-slate-300 text-xs font-medium"><?php echo e($event->event_time->format('d M Y, h:i A')); ?></td>
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                            <span class="badge <?php echo e($bClass); ?> px-2.5 py-1 font-weight-bold text-xs"><?php echo e(ucfirst($event->status)); ?></span>
                                                        </td>
                                                    </tr>
                    ...
                    <div class="tab-pane fade <?php echo e($activeTab === 'proof' ? 'show active' : ''); ?>" id="tab-proof" role="tabpanel">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="leader-card">
                                    ...
                                    <?php $approvedEvents = $events->where('status', 'approved')->where('proof_submitted', false); ?>
                                    
                                    <?php if($approvedEvents->isEmpty()): ?>
                                        ...
                                        <form action="" method="POST" id="proofForm" enctype="multipart/form-data" class="space-y-4 mt-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="proofEventSelect" required class="form-control form-control-dark" onchange="updateProofFormAction(this.value)">
                                                    ...
                                                    <?php $__currentLoopData = $approvedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($e->id); ?>">
                                                            <?php echo e($e->title); ?> (<?php echo e($e->event_time->format('d M Y')); ?>)
                                                        </option>
                                ...
                                <?php $proofEvents = $events->where('proof_submitted', true); ?>
                                <?php if($proofEvents->isNotEmpty()): ?>
                                    <div class="leader-card p-0 overflow-hidden mt-4">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-dark-custom mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $proofEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td class="font-weight-bold text-light"><?php echo e($e->title); ?></td>
                                                            <td>
                                                                <?php if($e->proof_files): ?>
                                                                    <a href="<?php echo e(asset('storage/' . $e->proof_files)); ?>" target="_blank" class="btn btn-xs btn-outline-info font-weight-bold" style="border-radius: 4px;">
                                                            ...
                                                            <td><small class="text-muted" title="<?php echo e($e->proof_notes); ?>"><?php echo e(Str::limit($e->proof_notes, 40)); ?></small></td>
                                                            <td class="text-center">
                                                                <?php
                                                                ...
                                                                ?>
                                                                <span class="badge <?php echo e($pbClass); ?> px-2.5 py-1 font-weight-bold text-xs"><?php echo e(ucfirst($e->proof_status)); ?></span>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                    ...
                    <div class="tab-pane fade <?php echo e($activeTab === 'ambassador' ? 'show active' : ''); ?>" id="tab-ambassador" role="tabpanel">
                        <div class="row">
                            
                            <div class="col-lg-5 mb-4">
                                <div class="leader-card">
                                    <h5 class="font-weight-bold mb-3 text-info"><i class="fas fa-bullhorn mr-2"></i>Register Ambassador Link</h5>
                                    <form action="<?php echo e(route('team-leader.socials.store')); ?>" method="POST" class="space-y-3">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <small class="font-mono text-info"><a href="<?php echo e($social->profile_link); ?>" target="_blank" class="text-info"><?php echo e(Str::limit($social->profile_link, 30)); ?></a></small>
                                                        </td>
                                                        <td class="text-right font-weight-bold text-slate-300"><?php echo e(number_format($social->views_count, 0)); ?></td>
                                                        <td class="text-center">
                                                            <?php
                                                            ...
                                                            ?>
                                                            <span class="badge <?php echo e($sbClass); ?> px-2.5 py-1 font-weight-bold text-xs"><?php echo e(ucfirst($social->status)); ?></span>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <tr>
                    ...
                    <div class="tab-pane fade <?php echo e($activeTab === 'videos' ? 'show active' : ''); ?>" id="tab-videos" role="tabpanel">
                        <div class="leader-card">
                            ...
                            <?php if($adminVideos->isEmpty()): ?>
                                <div class="text-center py-5 text-muted">
                                    <i class="fas fa-film fa-3x text-slate-600 mb-3 block"></i>No official promotion videos available at this time.
                                </div>
                            <?php else: ?>
                                <div class="row">
                                    <?php $__currentLoopData = $adminVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="card bg-dark border border-secondary shadow-sm h-100" style="border-radius: 12px; overflow: hidden;">
                                                ...
                                                <?php if($video->video_type === 'youtube'): ?>
                                                    ...
                                                    ?>
                                                    <?php if($ytId): ?>
                                                        <iframe class="w-100" style="height: 180px;" src="https://www.youtube.com/embed/<?php echo e($ytId); ?>" frameborder="0" allowfullscreen></iframe>
                                                    <?php else: ?>
                                                ...
                                                <div class="card-body p-3 flex-column justify-content-between">
                                                    <h6 class="font-weight-bold text-light mb-1.5 leading-snug"><?php echo e($video->title); ?></h6>
                                                    <div class="d-flex justify-content-between align-items-center text-xs mt-3 pt-2 border-top border-secondary">
                                                        <span class="text-slate-400 font-mono"><i class="fas fa-play-circle mr-1"></i> <?php echo e(number_format($video->views_count)); ?> reached</span>
                                                        <span class="text-indigo-400 font-bold"><i class="fas fa-clock mr-1"></i> <?php echo e($video->duration_seconds); ?> sec</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade <?php echo e($activeTab === 'banners' ? 'show active' : ''); ?>" id="tab-banners" role="tabpanel">
                        <div class="leader-card">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="card bg-dark border border-secondary shadow-sm h-100" style="border-radius: 12px; overflow: hidden;">
                                                <div class="p-1 bg-slate-900 d-flex align-items-center justify-content-center" style="height: 200px; overflow: hidden;">
                                                    <img src="<?php echo e(asset('storage/' . $banner->image_path)); ?>" class="img-fluid rounded max-h-[190px]" alt="<?php echo e($banner->title); ?>" onerror="this.src='https://placehold.co/400x250?text=Marketing+Creative';">
                                                </div>
                                                <div class="card-body p-3">
                                                    <h6 class="font-weight-bold text-light mb-1 leading-snug"><?php echo e($banner->title); ?></h6>
                                                    <p class="text-xs text-muted leading-relaxed mt-2" style="font-family: inherit;"><?php echo e(Str::limit($banner->description, 75)); ?></p>
                                                    <div class="d-flex justify-content-between align-items-center text-xs mt-3 pt-2 border-top border-secondary">
                                                        <a href="<?php echo e(asset('storage/' . $banner->image_path)); ?>" target="_blank" download class="btn btn-xs btn-outline-info font-weight-bold w-100 text-center" style="border-radius: 6px;">
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/team-leader/dashboard.blade.php ENDPATH**/ ?>