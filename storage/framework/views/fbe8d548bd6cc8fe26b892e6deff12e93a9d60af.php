            ...
            <form method="post" action="<?php echo e(route('user.withdraw')); ?>">
                ...
                <div class="row my-2">
                  <label for="" class="ml-2">  <?php if(!$wallet): ?>  No wallet adress found, go in <a  href="<?php echo e(route('profile.edit')); ?>" style="color:blue">Profile</a> to set it <?php else: ?> Wallet Address <small>
                    ...
                    <div class="col-md-10">
                      <input type="text"  id="amount" name="address" readonly class="form-control" value="<?php echo e($wallet->wallet); ?>">
                    </div>
                    <!--<div class="col-md-2">-->
...
<?php /**PATH /home/cwkwkueb/test.focoin.eu/resources/views/user/balance/withdraw.blade.php ENDPATH**/ ?>