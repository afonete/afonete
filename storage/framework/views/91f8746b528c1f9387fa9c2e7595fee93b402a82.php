<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container-fluid py-4">
            ...
            <?php if(isset($isSingleView) && $isSingleView && isset($activePayment)): ?>
                ...
                <div class="content-header mb-3">
                    <h1 class="m-0 text-dark font-weight-bold" style="font-size: 1.8rem;">
                        <i class="fas fa-sync-alt mr-2 text-info"></i> Renew Package: <?php echo e($activePayment->package ?? ''); ?>

                    </h1>
                    <small class="text-muted">
                        Renewal <?php echo e($renewalNumber ?? 0); ?> of <?php echo e($maxRenewals ?? 0); ?> &mdash;
                        Package runs <?php echo e($pkgDuration ?? 0); ?> days, renewed every 30 days
                        <?php if(isset($isPartialFee) && $isPartialFee): ?>
                            &mdash; <strong>Final renewal covers <?php echo e($leftoverDays ?? 0); ?> leftover days</strong>
                        <?php endif; ?>
                    </small>
                </div>
                ...
                <div class="alert alert-info py-2 mb-3" style="font-size:13px; border-radius: 8px;">
                    ...
                    (only <?php echo e($leftoverDays ?? 0); ?> day<?php echo e(($leftoverDays ?? 0) > 1 ? 's' : ''); ?> left if applicable).
                </div>
                ...
                <?php if(isset($isDue) && !$isDue): ?>
                    <div class="alert alert-warning" style="border-radius: 8px;">
                        ...
                        <strong><?php echo e(isset($renewalDueDate) ? $renewalDueDate->format('d M Y') : ''); ?></strong>.
                    </div>
                <?php endif; ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-7">
                        ...
                        <div class="card card-outline card-info shadow-sm" style="border-radius: 12px; overflow: hidden;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <small class="text-info font-weight-bold"><?php echo e(($renewalNumber ?? 1) - 1); ?> / <?php echo e($maxRenewals ?? 1); ?> completed</small>
                                    </div>
                                    <div class="progress" style="height: 12px; border-radius: 6px; background-color: #e9ecef;">
                                        <?php $progress = (($maxRenewals ?? 1) > 0) ? ((($renewalNumber ?? 1) - 1) / ($maxRenewals ?? 1)) * 100 : 0; ?>
                                        <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" style="width: <?php echo e($progress); ?>%; border-radius: 6px;"></div>
                                    </div>
                                    <small class="text-muted d-block mt-2" style="font-size: 0.78rem;">
                                        Day 30 &bull; Day 60 &bull; Day 90 &mdash; Package expires at Day <?php echo e($pkgDuration ?? 0); ?>

                                        <?php if(isset($leftoverDays) && $leftoverDays > 0 && isset($isPartialFee) && $isPartialFee): ?>
                                            &mdash; Final renewal covers Day <?php echo e(($pkgDuration ?? 0) - $leftoverDays + 1); ?>–<?php echo e($pkgDuration ?? 0); ?> (<?php echo e($leftoverDays); ?> days)
                                        <?php endif; ?>
                                    </small>
                                </div>

                                
                                <?php if(isset($schedule) && is_array($schedule) && count($schedule) > 0): ?>
                                <div class="mb-4">
                                        ...
                                        <table class="table table-sm table-bordered mb-0" style="font-size:13px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="<?php echo e($rowBg); ?>">
                                                    ...
                                                    <td>
                                                        <small class="font-weight-bold">Day <?php echo e($row['due_at_day']); ?></small><br>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right font-weight-bold" style="font-size: 1.15rem; vertical-align: middle;">
                                                <span class="<?php echo e(($tradingVoucherBalance ?? 0) >= ($renewalFee ?? 0) ? 'text-success' : 'text-danger'); ?>">
                                                    $<?php echo e(number_format($tradingVoucherBalance ?? 0, 2)); ?>
                                        ...
                                        <tr>
                                            <td class="text-muted pl-0">
                                                ...
                                                <small class="d-block text-muted">
                                                    <?php if(isset($isPartialFee) && $isPartialFee): ?>
                                                        Pro-rated for <?php echo e($daysCovered ?? 0); ?> days &divide; 30
                                                        (monthly: $<?php echo e(number_format($monthlyFee ?? 0, 2)); ?>)
                                                    <?php else: ?>
                                            ...
                                            <td class="text-right font-weight-bold text-danger" style="font-size: 1.1rem; vertical-align: middle;">
                                                &minus; $<?php echo e(number_format($renewalFee ?? 0, 2)); ?>
                                        ...
                                        <tr class="border-top">
                                            ...
                                            <td class="text-right font-weight-bold" style="vertical-align: middle;">
                                                $<?php echo e(number_format($tokenPrice ?? 0, 4)); ?> / token
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted pl-0">
                                            ...
                                            <td class="text-right" style="vertical-align: middle;">
                                                <span class="badge badge-success px-3 py-2" style="font-size: 0.95rem;">
                                                    <?php echo e(number_format($tokensToReceive ?? 0, 4)); ?> tokens
                                                </span>
                                            </td>
                                        </tr>
                                        <tr class="border-top">
                                            ...
                                            <td class="text-right font-weight-bold" style="vertical-align: middle;">
                                                #<?php echo e($renewalNumber ?? 0); ?> of <?php echo e($maxRenewals ?? 0); ?>

                                            </td>
                                        </tr>
                                        <?php if(($renewalNumber ?? 0) < ($maxRenewals ?? 0)): ?>
                                        <tr>
                                            <td class="text-muted pl-0">
                                        ...
                                        <tr>
                                            <td colspan="2" class="text-center text-muted py-2 bg-light rounded mt-2">
                                                ...
                                                <?php if(isset($isPartialFee) && $isPartialFee): ?>
                                                    ...
                                                    &mdash; covers <?php echo e($leftoverDays ?? 0); ?> leftover days.
                                                <?php else: ?>
                                                    This is your <strong>final renewal</strong> for this package cycle.
                                                <?php endif; ?>
                                            </td>
                            ...
                            <?php if(($tradingVoucherBalance ?? 0) < ($renewalFee ?? 0)): ?>
                                <div class="card-footer bg-danger text-white text-center py-3">
                                    <i class="fas fa-exclamation-triangle mr-1"></i>
                                    Insufficient Trading Voucher balance. You need
                                    <strong>$<?php echo e(number_format($renewalFee ?? 0, 2)); ?></strong>
                                    but only have
                                    <strong>$<?php echo e(number_format($tradingVoucherBalance ?? 0, 2)); ?></strong>.
                                </div>
                            <?php else: ?>
                                <div class="card-footer p-0">
                                    ...
                                    <?php else: ?>
                                        <button type="button" class="btn btn-secondary btn-block py-3 font-weight-bold" disabled
                                            ...
                                            Available on <?php echo e(isset($renewalDueDate) ? $renewalDueDate->format('d M Y') : ''); ?>
                        ...
                        <div class="text-center mt-3">
                            <a href="<?php echo e(route('packageRenew')); ?>" class="btn btn-sm btn-outline-secondary">
            ...
            <?php else: ?>
                            ...
                            <div class="card-body py-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2 class="font-weight-bold mb-0 mt-1" style="font-size: 2.2rem;">
                                            <?php echo e(isset($packagesData) && is_array($packagesData) ? count($packagesData) : 0); ?>
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
                    ...
                    <div class="card-body p-0">
                        <?php if(!isset($packagesData) || empty($packagesData)): ?>
                            <div class="text-center py-5">
                                ...
                                <a href="<?php echo e(route('user.venture')); ?>" class="btn btn-primary px-4 py-2 font-weight-bold" style="border-radius: 8px;">
                        ...
                        <?php else: ?>
                            <div class="table-responsive">
                                <table class="table table-hover table-striped align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $packagesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <?php if($payment): ?>
                                                <tr style="height: 90px; vertical-align: middle;">
                                                    ...
                                                    <td class="pl-4" style="vertical-align: middle;">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <small class="text-muted">
                                                                    Invested Capital: <strong>$<?php echo e(number_format($payment->amount, 2)); ?></strong>
                                                                </small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        ...
                                                        <small class="text-muted">
                                                            Expires: <?php echo e(\Carbon\Carbon::parse($payment->expiration_date)->format('d M Y')); ?>
                                                    ...
                                                    <td class="text-center" style="width: 220px; vertical-align: middle;">
                                                        <div class="px-3">
                                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.78rem;">
                                                                ...
                                                                <span class="text-primary font-weight-bold"><?php echo e($renewalsDone); ?> / <?php echo e($maxRenewals); ?></span>
                                                            </div>
                                                            <div class="progress" style="height: 8px; border-radius: 4px; background-color: #e9ecef;">
                                                                <?php $pct = $maxRenewals > 0 ? ($renewalsDone / $maxRenewals) * 100 : 0; ?>
                                                                <div class="progress-bar bg-primary" style="width: <?php echo e($pct); ?>%; border-radius: 4px;"></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        ...
                                                        <?php else: ?>
                                                            <span class="d-block text-dark font-weight-bold" style="font-size: 0.88rem;">
                                                                Upcoming Cycle #<?php echo e($data['renewalNumber'] ?? 1); ?>

                                                            </span>
                                                            <small class="text-muted d-block">
                                                                Due: <?php echo e($renewalDueDate ? $renewalDueDate->format('d M Y') : '—'); ?>
                                                    ...
                                                    <td class="text-right pr-4" style="vertical-align: middle;">
                                                        ...
                                                        <?php elseif($isDue): ?>
                                                            ...
                                                            <a href="<?php echo e(route('packageRenew', $payment->id)); ?>" 
                                                               ...
                                                               style="border-radius: 8px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); transition: transform 0.2s;">
                                                                <i class="fas fa-sync-alt mr-1"></i> Renew Now ($<?php echo e(number_format($data['renewalFee'] ?? 0, 2)); ?>)
                                                            </a>
                                                        <?php else: ?>
                                                            <a href="<?php echo e(route('packageRenew', $payment->id)); ?>" class="btn btn-outline-secondary font-weight-bold px-3 py-2" style="border-radius: 8px; font-size: 0.85rem;">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 12px; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
                    ...
                    <div class="p-3 bg-light rounded-lg mb-4" style="border-radius: 8px;">
                        <table class="table table-sm table-borderless mb-0" style="color: #4b5563;">
                            <tr style="height: 30px; vertical-align: middle;">
                                ...
                                <td class="font-weight-bold text-danger text-right pr-0" style="font-size: 1.15rem;">$<?php echo e(number_format($renewalFee ?? 0, 2)); ?></td>
                            </tr>
                            <tr style="height: 30px; vertical-align: middle;">
                                <td class="text-muted pl-0">Token price:</td>
                                <td class="font-weight-bold text-dark text-right pr-0">$<?php echo e(number_format($tokenPrice ?? 0, 4)); ?></td>
                            </tr>
                            <tr style="height: 30px; vertical-align: middle;">
                                <td class="text-muted pl-0">Tokens you receive:</td>
                                <td class="font-weight-bold text-success text-right pr-0" style="font-size: 1.15rem;"><?php echo e(number_format($tokensToReceive ?? 0, 4)); ?></td>
                            </tr>
                            <tr style="height: 30px; vertical-align: middle;">
                                <td class="text-muted pl-0">Renewal cycle:</td>
                                <td class="font-weight-bold text-dark text-right pr-0">#<?php echo e($renewalNumber ?? 0); ?> of <?php echo e($maxRenewals ?? 0); ?></td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="modal-footer bg-light border-0 py-3 d-flex justify-content-end gap-2">
                    ...
                    <form action="<?php echo e(route('packageRenewPay')); ?>" method="POST" class="d-inline mb-0">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="payment_id" value="<?php echo e($activePayment->id ?? 0); ?>">
