            ...
            <div class="payment-card">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-deposits" role="tabpanel" aria-labelledby="pills-deposits-tab">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="trx-code" title="<?php echo e($deposit->transaction_id); ?>">
                                            ...
                                            <td>
                                                <span class="badge badge-light border px-2 py-1 text-slate-600 font-weight-bold">
                                                    <?php echo e($deposit->deposit_method ?: 'N/A'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-muted" style="font-size: 0.8rem;">
                                                    <i class="far fa-clock mr-1"></i> <?php echo e($deposit->created_at->format('Y-m-d h:i A')); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($deposit->status == 'used'): ?>
                                                ...
                                                <?php else: ?>
                                                    <span class="badge badge-secondary px-2 py-1 font-weight-bold"><?php echo e(ucfirst($deposit->status)); ?></span>
                                                <?php endif; ?>

                                                
                                                <?php if(!empty($deposit->comment)): ?>
                                                    <div class="text-xs text-muted mt-1" style="max-width: 200px; line-height: 1.3;">
                                                        ...
                                                        <span class="font-italic">"<?php echo e($deposit->comment); ?>"</span>
                                                    </div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-right">
                                                <?php if(($deposit->status == 'pending' || $deposit->status == 'rejected') && !empty($deposit->transaction_id)): ?>
                                                    <form method="POST" action="<?php echo e(route('user.claim')); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="transactionId" value="<?php echo e($deposit->transaction_id); ?>">
                                                        <button type="submit" class="btn btn-danger btn-sm font-weight-bold" style="border-radius: 6px; transition: all 0.2s;"
                                                            onclick="return confirm('Are you sure you want to request approval / report an issue for Transaction ID: <?php echo e($deposit->transaction_id); ?>?')">
                        ...
                        <?php if($deposits->total() > 10): ?>
                            <div class="pagination-wrapper">
                                <?php echo e($deposits->appends(request()->except('deposits_page'))->links('pagination::bootstrap-4')); ?>
                    ...
                    <div class="tab-pane fade" id="pills-purchases" role="tabpanel" aria-labelledby="pills-purchases-tab">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $investments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <span class="font-weight-bold text-slate-500">
                                                    <?php echo e(($investments->currentPage() - 1) * $investments->perPage() + $loop->iteration); ?>
                                            ...
                                            <td>
                                                <span class="badge badge-primary px-3 py-2 font-weight-bold" style="background-color: #6366f1 !important; border-radius: 6px; font-size: 0.8rem;">
                                                    <i class="fas fa-gem mr-1"></i> <?php echo e($inv->package ?: 'VENTURE'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-success font-weight-bold" style="font-size: 0.95rem;">
                                                    $<?php echo e(number_format($inv->paid, 2)); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-muted" style="font-size: 0.8rem;">
                                                    <i class="far fa-calendar-alt mr-1"></i> <?php echo e($inv->created_at->format('Y-m-d h:i A')); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <span class="text-muted" style="font-size: 0.8rem;">
                                                    <i class="far fa-calendar-times mr-1"></i> <?php echo e($inv->expiration_date ?: 'N/A'); ?>
                        ...
                        <?php if($investments->total() > 10): ?>
                            <div class="pagination-wrapper">
                                <?php echo e($investments->appends(request()->except('purchases_page'))->links('pagination::bootstrap-4')); ?>
