...
<?php endif; ?>
        ...
        <div class="block sm:grid grid-cols-2 my-2 gap-2">
            ...
            <div class="bg-white p-4 flex flex-col rounded-lg my-2 sm:my-0">
                    ...
                    <form class="flex flex-col gap-2" method="POST" action="<?php echo e(route('transfer-touser')); ?>" id="cashoutTransferForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <small class="text-gray-500">
                            Available CASHOUT: $<?php echo e(number_format($cashout, 2)); ?>
                    ...
                    (function () {
                        ...
                        lookupBtn.addEventListener('click', function () {
                            ...
                            fetch('<?php echo e(route("transfer-touser.lookup")); ?>?email=' + encodeURIComponent(email))
                                .then(r => r.json())
                                .then(data => {
                                    if (data.found) {
