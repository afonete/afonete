...
<?php endif; ?>
        ...
        <div class="border px-4 py-4 rounded-lg my-4 bg-white shadow-sm">
            <div class="flex justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <h1 class="text-gray-900 font-extrabold text-2xl" id="balance">$<?php echo e(number_format($cashout, 2)); ?></h1>
        ...
        <div class="block sm:grid grid-cols-2 my-2 gap-3">
            ...
            <div class="bg-white p-5 flex flex-col rounded-xl my-2 sm:my-0 shadow-sm border border-gray-200">
                    ...
                    <?php if(session('success-touser')): ?>
                        <div class="bg-emerald-500 text-white font-bold rounded-lg px-4 py-2.5 mb-3 text-xs shadow-sm flex items-center justify-between" role="alert">
                            <span><i class="fa fa-check-circle mr-1.5"></i> <?php echo e(session('success-touser')); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(session('error-touser')): ?>
                        <div class="bg-rose-500 text-white font-bold rounded-lg px-4 py-2.5 mb-3 text-xs shadow-sm flex items-center justify-between" role="alert">
                            <span><i class="fa fa-exclamation-triangle mr-1.5"></i> <?php echo e(session('error-touser')); ?></span>
                        </div>
                    <?php endif; ?>

                    <hr class="mb-3 border-gray-100"/>

                    <form class="flex flex-col gap-3 js-transaction-password-form" method="POST" action="<?php echo e(route('transfer-touser')); ?>" id="cashoutTransferForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="border border-gray-300 rounded-lg flex overflow-hidden focus-within:ring-2 focus-within:ring-yellow-500 focus-within:border-yellow-500">
                                <input type="text" name="recipient" id="recipientInput"
                                       ...
                                       value="<?php echo e(old('recipient')); ?>"
                        ...
                        <div class="text-right">
                            <span class="text-gray-500 font-semibold text-[11px]">
                                Available Cashout: <strong class="text-gray-800">$<?php echo e(number_format($cashout, 2)); ?></strong>
                            </span>
                        </div>
                    </form>
                    ...
                    (function () {
                        ...
                        if (lookupBtn && recipientInput) {
                            lookupBtn.addEventListener('click', function () {
                                ...
                                fetch('<?php echo e(route("transfer-touser.lookup")); ?>?query=' + encodeURIComponent(q))
                                    .then(r => r.json())
                                    .then(data => {
                                        if (data.found) {
            ...
            <div class="bg-white p-5 flex flex-col rounded-xl my-2 sm:my-0 shadow-sm border border-gray-200">
                ...
                <?php if(session('success-internal')): ?>
                    <div class="bg-emerald-500 text-white font-bold rounded-lg px-4 py-2.5 mb-3 text-xs shadow-sm" role="alert">
                        <i class="fa fa-check-circle mr-1.5"></i> <?php echo e(session('success-internal')); ?>

                    </div>
                <?php endif; ?>

                <?php if(session('error-internal')): ?>
                    <div class="bg-rose-500 text-white font-bold rounded-lg px-4 py-2.5 mb-3 text-xs shadow-sm" role="alert">
                        <i class="fa fa-exclamation-triangle mr-1.5"></i> <?php echo e(session('error-internal')); ?>
                ...
                <form class="flex flex-col gap-3 js-transaction-password-form" method="POST" action="<?php echo e(route('user.internal-exchange.transfer')); ?>" id="internalWalletTransferForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="transaction_password" class="js-transaction-password-value">
                    ...
                    <div>
                        ...
                        <select name="from_wallet" id="paymentsFromWallet" required onchange="updatePaymentsDestOptions()" class="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-xs font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                            ...
                            <option value="CASHOUT">Cashout Wallet ($<?php echo e(number_format($cashout, 2)); ?>)</option>
            ...
            <div class="bg-white p-5 flex flex-col justify-between rounded-xl my-2 sm:my-0 shadow-sm border border-gray-200">
                ...
                <div class="pt-2">
                    <a href="<?php echo e(route('user.dashboard.payments')); ?>" class="w-full bg-yellow-500 hover:bg-yellow-600 px-4 py-2.5 rounded-lg text-white font-bold shadow-sm transition text-xs flex items-center justify-center gap-1.5 text-center block" style="text-decoration: none;">
            ...
            <div class="bg-white p-4 flex flex-col rounded-lg my-2 sm:my-0">
                ...
                <hr/>
                <form class="flex gap-2  flex-wrap js-transaction-password-form" method="POST" action="<?php echo e(route('transferToAccount')); ?>" id="transferForm">
                    <?php echo csrf_field(); ?>
        ...
        <div class="my-4 p-5 bg-white rounded-xl shadow-sm border border-gray-200 col-span-2">
                ...
                <table class="w-full text-left text-xs text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <?php if(isset($history) && $history->count() > 0): ?>
                            <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="py-3.5 px-4 font-bold text-gray-500"><?php echo e(method_exists($history, 'currentPage') ? (($history->currentPage() - 1) * $history->perPage() + $loop->iteration) : $loop->iteration); ?></td>
                                    <td class="py-3.5 px-4 font-mono font-bold text-gray-900"><?php echo e($t->transaction_no); ?></td>
                                    <td class="py-3.5 px-4">
                                        <?php if($t->transaction_type === 'CASHOUT_TRANSFER_SENT'): ?>
                                            <span class="bg-amber-100 text-amber-800 px-2 py-0.5 rounded text-[10px] font-bold">SENT</span>
                                        <?php elseif($t->transaction_type === 'CASHOUT_TRANSFER_RECEIVED'): ?>
                                            <span class="bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded text-[10px] font-bold">RECEIVED</span>
                                        <?php elseif($t->transaction_type === 'INTERNAL_WALLET_TRANSFER'): ?>
                                            <span class="bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded text-[10px] font-bold">INTERNAL</span>
                                        <?php else: ?>
                                            <span class="bg-gray-100 text-gray-800 px-2 py-0.5 rounded text-[10px] font-bold"><?php echo e($t->transaction_type); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-3.5 px-4 font-medium">
                                        <?php if(isset($d['from_wallet']) && isset($d['to_wallet'])): ?>
                                            Transferred <strong>$<?php echo e(number_format($d['amount'] ?? 0, 2)); ?></strong> from <?php echo e($fromName); ?> to <?php echo e($toName); ?>

                                        <?php elseif($t->transaction_type === 'CASHOUT_TRANSFER_SENT' || !empty($d['to_username']) || !empty($d['to_user'])): ?>
                                            Sent <strong>$<?php echo e(number_format($d['amount'] ?? 0, 2)); ?></strong> to @ <?php echo e($d['to_username'] ?? ($d['to_user'] ?? '—')); ?> (Code: <?php echo e($d['to_code'] ?? '—'); ?>)
                                        <?php elseif($t->transaction_type === 'CASHOUT_TRANSFER_RECEIVED' || !empty($d['from_username']) || !empty($d['from_user'])): ?>
                                            Received <strong>$<?php echo e(number_format($d['amount'] ?? 0, 2)); ?></strong> from @ <?php echo e($d['from_username'] ?? ($d['from_user'] ?? '—')); ?> (Code: <?php echo e($d['from_code'] ?? '—'); ?>)
                                        <?php else: ?>
                                    ...
                                    <td class="py-3.5 px-4 text-right font-mono text-gray-500">
                                        <?php echo e($t->created_at ? $t->created_at->format('Y-m-d H:i') : '—'); ?>
            ...
            <?php if(isset($history) && method_exists($history, 'hasPages') && $history->hasPages()): ?>
                        ...
                        <div class="py-3 px-3 border rounded bg-white shadow-sm">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/pancake.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/okx.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/exchange.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/kucoin.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/yo.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/bybit.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/binance.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                                <div class="py-3 px-2 text-center rounded block">
                                    <img src="<?php echo e(asset("image/bitcoin.jpeg")); ?>" style="width:50px;height:50px;object-fit:cover" class="rounded-full mx-auto shadow-sm border">
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <script>
                    ...
                    if (acc_choice) {
                        acc_choice.addEventListener("change", function(e) {
                            ...
                            fetch('<?php echo e(url("user/dashboard/finance/account")); ?>?ac=' + encodeURIComponent(selected))
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/payments.blade.php ENDPATH**/ ?>