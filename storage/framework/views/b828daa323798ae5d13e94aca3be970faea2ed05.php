    ...
    <div class="content-header">
      <div class="container-fluid">
           <div class="tabs tab_links" >
              ...
              <a  href="<?php echo e(route('user.dashboard.payvideo.invoice')); ?>" class="fomoLink" ><i class="fa-solid fa-book"></i> Invoices </a>
...
<div class="col-md-4">
    ...
    <div class="mr-3">
        <img src="<?php echo e(asset('image/fb.png')); ?>" class="img-fluid rounded-lg shadow" 
    ...
    <div class="flex-grow-1">
        <div class="mb-2">
            ...
            <img src="<?php echo e(asset('image/diamond.png')); ?>" class="rounded-circle" 
...
<div class="col-md-4">
    <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
        ...
        <div class="d-flex align-items-center" style="padding: 8px;">
    <div class="mr-3">
        <img src="<?php echo e(asset('image/inst.png')); ?>" class="img-fluid rounded-lg shadow" 
             style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
    </div>
 ...
 <div class="col-md-4">
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/tg.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
...
<div class="col-md-4">
    <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
        ...
        <div class="d-flex align-items-center" style="padding: 8px;">
    <div class="mr-3">
        <img src="<?php echo e(asset('image/x.png')); ?>" class="img-fluid  rounded-lg shadow" 
             style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
    </div>
...
<div class="col-md-4">
    <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
        ...
        <div class="d-flex align-items-center" style="padding: 8px;">
    <div class="mr-3">
        <img src="<?php echo e(asset('image/frnd.png')); ?>" class="img-fluid  rounded-lg shadow" 
             style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
    </div>
...
<div class="col-md-4">
  ...
  <div class="col-md-4">
        ...
        <div class="flex-grow-1">
            <div class="mb-2">
                ...
                <div class="d-flex align-items-center">
                <img src="<?php echo e(asset('image/coin.png')); ?>" class="rounded-circle" 
  ...
  <div class="col-md-4">
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/tik.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
      ...
      <div class="col-md-4">
        ...
        <div class="flex-grow-1">
            <div class="mb-2">
                <div class="d-flex align-items-center mb-2">
                    <span class="text-white   mb-0">Post About <?php echo e((env('APP_NAME'))); ?> On X </span>
                </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/clndr.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
        ...
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/hs.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
        ...
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/usrinv.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
        ...
        <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #00008B, #000066);">
            ...
            <div class="d-flex align-items-center" style="padding: 8px;">
        <div class="mr-3">
            <img src="<?php echo e(asset('image/ytb.png')); ?>" class="img-fluid rounded-lg shadow" 
                 style="height: 50px; width: 50px; object-fit:" alt="Ad Image">
        </div>
    ...
    <?php echo $__env->make('user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/user/fearloss/tasks.blade.php ENDPATH**/ ?>