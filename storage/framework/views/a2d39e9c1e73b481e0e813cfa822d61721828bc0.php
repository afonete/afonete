...
<body style="font-family: sans-serif; background-color: #f4f5f7; padding: 20px; color: #333;">
    <div style="max-width: 500px; margin: 0 auto; background: #fff; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
        ...
        <p>Thank you for registering on Fonepo. To activate your account and verify your email address, please use the following single-use activation PIN code:</p>
        ...
        <p style="font-size: 0.8rem; color: #94a3b8; text-align: center; margin-bottom: 0;">&copy; <?php echo e(date('Y')); ?> Fonepo Inc. All rights reserved.</p>
    </div>
</body>
</html>
