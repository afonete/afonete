<?php $__env->startSection('contents'); ?>
    <div class="container bg-white min-h-screen py-4 px-3">
       ...
       <header class="bg-blue-50 py-[2rem] rounded  flex items-center justify-between">
        <h1 class="text-2xl uppercase text-slate-700 font-bold">LINK-CAMPAIN</h1>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <div class="border  rounded-lg self-start my-2 flex-1">
                        ...
                        <div class="mb-4 px-3 py-2">
                            <textarea rows="6" name="description" class="block w-full mt-2 py-3 px-2 border border-gray-300 rounded-lg" placeholder="Enter Description........"></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/campain/LinkCampain.blade.php ENDPATH**/ ?>