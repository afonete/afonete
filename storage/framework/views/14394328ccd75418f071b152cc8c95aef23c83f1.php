            ...
            <?php if(!$contract): ?>
                <div class="card border-0 shadow-sm" style="border-radius:12px;">
                    <div class="card-body p-4 text-center">
                        ...
                        <a href="<?php echo e(route('user.contract')); ?>" class="btn btn-primary font-weight-bold px-4 py-2" style="border-radius:8px;">
                            Sign Contract Now →
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="card border-0 shadow-sm h-100" style="border-radius:12px; border-left:4px solid #3b82f6 !important;">
                            <div class="card-body p-3.5">
                                ...
                                <h5 class="font-weight-bold text-dark mb-1" style="font-size:1.1rem;"><?php echo e($contract->user->name ?? $contract->name); ?></h5>
                                <div class="text-muted small"><i class="fas fa-envelope mr-1 text-primary"></i> <?php echo e($contract->user->email ?? '—'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                        <div class="card border-0 shadow-sm h-100" style="border-radius:12px; border-left:4px solid #6366f1 !important;">
                            <div class="card-body p-3.5">
                                ...
                                <div class="font-weight-bold text-slate-800 mb-1" style="font-size:1rem;">@ <?php echo e($contract->user->user ?? '—'); ?></div>
                                <div class="text-muted small">User ID: <strong>#<?php echo e($contract->user_id); ?></strong> · Country: <strong><?php echo e($contract->user->country ?? '—'); ?></strong></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100" style="border-radius:12px; border-left:4px solid #10b981 !important;">
                            <div class="card-body p-3.5 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <div class="text-muted small">Signed: <strong><?php echo e($contract->created_at ? $contract->created_at->format('M d, Y H:i') : '—'); ?></strong></div>
                                </div>
                                <div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3 border-bottom pb-2" style="border-bottom-color: rgba(255,255,255,0.15) !important;">
                            ...
                            <span class="badge badge-warning text-dark font-weight-bold px-2.5 py-1" style="border-radius:4px; font-size:0.72rem;">
                                Contract Ref #<?php echo e($contract->id); ?>
