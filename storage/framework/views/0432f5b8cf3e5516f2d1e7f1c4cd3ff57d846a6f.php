...
<div class="p-6 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
        ...
        <!-- Settings Form Card -->
        <form method="POST" action="<?php echo e(route('admin.enable-free-user.update')); ?>">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="flex flex-col items-center gap-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="allow_free_dashboard_access" value="1" class="sr-only peer"
                                       <?php echo e(($settings->allow_free_dashboard_access ?? false) ? 'checked' : ''); ?>>
                            ...
                            <span class="text-xs uppercase font-extrabold tracking-wider 
                                         <?php echo e(($settings->allow_free_dashboard_access ?? false) ? 'text-green-600' : 'text-gray-400'); ?>">
                                <?php echo e(($settings->allow_free_dashboard_access ?? false) ? 'Status: ON' : 'Status: OFF'); ?>
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-5 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-gray-100 transition-all">
                    Cancel
                </a>
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/settings/free-user-on-register.blade.php ENDPATH**/ ?>