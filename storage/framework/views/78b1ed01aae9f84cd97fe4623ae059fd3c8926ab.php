        ...
        <div class="overflow-x-auto">
            <?php if(count($messages)): ?>
                <table class="min-w-full bg-white border border-gray-200 text-center">
                    ...
                    <tbody>
                        <tr class="border-t">
                            <td class="py-2 px-4 border-r"><?php echo e($n++); ?></td>
                            <td class="py-2 px-4 border-r"><?php echo e($row->name); ?></td>
                            <td class="py-2 px-4 border-r"><?php echo e($row->sur); ?></td>
                            <td class="py-2 px-4 border-r"><?php echo e($row->email); ?></td>
                            <td class="py-2 px-4 border-r"><?php echo e($row->phone); ?></td>
                            <td class="py-2 px-4"><?php echo e($row->message); ?></td>
                        </tr>
                    </tbody>
                    <?php endforeach; ?>
                </table>
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/contacted.blade.php ENDPATH**/ ?>