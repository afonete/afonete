 ...
 <div class="col-md-4">
    <div class="card shadow-lg" style="border-radius: 15px; background: linear-gradient(145deg, #0099ff, #0066cc);">
        ...
        <div class="d-flex align-items-center p-3">
            <div class="mr-3">
                <img src="<?php echo e(asset('image/adss3.png')); ?>" class="img-fluid rounded-lg shadow" 
            ...
            <div class="flex-grow-1">
                <div class="mb-2">
                    <div class="d-flex align-items-center mb-2">
                        <img src="<?php echo e(asset('image/bn.png')); ?>" class="rounded-circle mr-2" 
                             style="height: 30px; width: 30px; object-fit: cover;" alt="Ad Image">
                        <h6 class="text-white font-weight-bold mb-0">Ad Name</h6>
                    </div>
                    
                    <div class="d-flex align-items-center">
                        <img src="<?php echo e(asset('image/coin.png')); ?>" class="rounded-circle mr-2" 
                             style="height: 30px; width: 30px; object-fit: cover;" alt="Ad Image">
...
<div class="col-md-4">
 ...
 <div class="row mx-5">
   ...
   <div class="col-md-4">
    ...
    <?php echo $__env->make('user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/user/fearloss/download-app.blade.php ENDPATH**/ ?>