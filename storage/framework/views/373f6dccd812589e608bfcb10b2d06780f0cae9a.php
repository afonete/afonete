            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div>
                    <?php if($isMonday && $totals['withdrawable'] > 0 && !$alreadyReq): ?>
                        <form method="POST" action="<?php echo e(route('user.referral.withdraw')); ?>" class="d-inline js-transaction-password-form">
                            <?php echo csrf_field(); ?>
                            ...
                            <button type="submit" class="btn btn-success btn-lg font-weight-bold"
                                    onclick="return confirm('Transfer $<?php echo e(number_format($totals['withdrawable'], 2)); ?> referral bonus to your Cashout wallet for withdrawal?')">
                                <i class="fas fa-wallet mr-1"></i>
                                Transfer $<?php echo e(number_format($totals['withdrawable'], 2)); ?> to Cashout
                            </button>
                        </form>
                ...
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($r->sourceUser->user ?? $r->sourceUser->name ?? '—'); ?></td>
                            <td>
                                <?php if($r->level > 0): ?>
