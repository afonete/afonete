    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center">
                ...
                <?php echo e(strtoupper(env('APP_NAME'))); ?>   </a>
            </div>

            <!-- Desktop Navigation -->
            <div class="hidden md:flex items-center space-x-8">
            <a href="<?php echo e(route('team.leader')); ?>" class="block px-4 text-white text-lg font-medium hover:border-b-2 hover:border-white ">LEADER</a>
            ...
            <a href="<?php echo e(route('team-leader.login')); ?>" class="bg-white hover:bg-slate-100 text-blue-800 font-bold px-4 py-2 rounded-full text-sm" style="text-decoration: none;">Leader Login</a>
            </div>
        ...
        <div class="mobile-menu hidden md:hidden pb-4">
            ...
            <a href="<?php echo e(route('team-leader.login')); ?>" class="block py-2 px-4 text-yellow-300 text-lg font-bold">LEADER LOGIN</a>
        </div>
    </div>
</nav>
...
</script><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/home/include/leadersnav.blade.php ENDPATH**/ ?>