...
<div class=" mx-auto">
	...
	<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="flex justify-between items-center  px-3">
             <a href="<?php echo e(route("fcpackages.create")); ?>" class="bg-blue-500 py-2 px-3 rounded text-gray-50">New <i class="fa fa-save"></i></a>
             <div class="p-4">
                    ...
                    <tr
						...
						<td class="px-6 py-4 text-right">
                           ...
                           <div class="flex gap-2">
                                ...
                                <a href="<?php echo e(route('fcpackages.edit',$deposit)); ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-2 py-2 rounded focus:outline-none" >
                            ...
                            <script>
                                ...
                                <a href="<?php echo e(route("fcpackages.investors",$deposit->id)); ?>" class="bg-gray-700 hover:bg-gray-800
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/fc/fcpackage.blade.php ENDPATH**/ ?>