                ...
                <div class="overflow-x-auto ">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <p>Start Date: <strong><?php echo e(request()->query('startDate')); ?></strong></p>
                            <p>To</p>
                            <p>End Date: <strong><?php echo e(request()->query('endDate')); ?></strong></p>
                        </div>
                    </div>
                ...
                <table class=" bg-white">
                        ...
                        <tbody>
                                <?php
                                  use Carbon\Carbon;
                                ?>
                            <?php $__currentLoopData = $trx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                            ...
                            <tr class="hover:bg-gray-100  hover:cursor-pointer">
                                ...
                                <td class="py-2 px-2 border-b border-gray-200"><?php echo e($loop->iteration); ?> </td>
                                <td class="py-2 px-2 border-b border-gray-200">
                                    <p class="badge badge-light"><?php echo e($date); ?></p>
                                </td>
                                ...
                                <td class="py-2 px-2 border-b border-gray-200"> <small>0.00 $</small> </td>
                                <td class="py-2 px-2 border-b border-gray-200"><small>0.00$</small></td>
                                <td class="py-2 px-2 border-b border-gray-200"> <small><?php echo e($data->amount); ?>.00$ </small></td>
                                <td class="py-2 px-2 border-b border-gray-200"><small>0.00$</small></td>
                                <td class="py-2 px-2 border-b border-gray-200"><small>0.00$</small></td>
                                <td class="py-2 px-2 border-b border-gray-200"> <small><?php echo e($data->amount); ?>.00$ </small></td>
...
<?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/user/commission-details.blade.php ENDPATH**/ ?>