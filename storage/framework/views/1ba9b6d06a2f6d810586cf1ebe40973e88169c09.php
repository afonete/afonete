        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px; overflow: hidden;">
            <div class="card-header bg-light p-3">
                <ul class="nav nav-pills gap-2">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('password.show')); ?>" class="nav-link active font-weight-bold text-xs py-2 px-3" style="border-radius: 8px;">
            ...
            <div class="col-md-6 mb-4">
                <div class="card shadow-sm border-0 h-100" style="border-radius: 12px; overflow: hidden;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?php echo e(route('transaction-password.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/password.blade.php ENDPATH**/ ?>