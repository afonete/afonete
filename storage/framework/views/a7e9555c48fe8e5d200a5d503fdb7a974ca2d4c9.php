...
<div class="container mx-auto py-6 px-4 sm:px-6 lg:px-8 max-w-7xl">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-6 sm:p-8">
            <form method="POST" action="<?php echo e(route('admin.settings.withdrawal-settings.update')); ?>" class="space-y-10">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-2">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                ...
                                <input type="number" step="0.01" min="0" name="min_amount" value="<?php echo e($settings->min_amount); ?>" required class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                <input type="number" step="0.01" min="0" max="100" name="withdrawal_fee_percent" value="<?php echo e($settings->withdrawal_fee_percent ?? 0.00); ?>" required class="rounded-l-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                        ...
                        <div>
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                <span class="inline-flex items-center px-3.5 text-sm font-bold text-gray-500 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">$</span>
                                <input type="number" step="0.01" min="0" name="max_per_transaction" value="<?php echo e($settings->max_per_transaction); ?>" required class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                <span class="inline-flex items-center px-3.5 text-sm font-bold text-gray-500 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">$</span>
                                <input type="number" step="0.01" min="0" name="admin_approval_threshold" value="<?php echo e($settings->admin_approval_threshold ?? 100); ?>" class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex rounded-xl shadow-sm">
                                <span class="inline-flex items-center px-3.5 text-sm font-bold text-gray-500 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">$</span>
                                <input type="number" step="0.01" min="0" name="max_auto_withdrawal" value="<?php echo e($settings->max_auto_withdrawal ?? 100); ?>" class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" min="0" max="100" name="manual_review_risk_score" value="<?php echo e($settings->manual_review_risk_score ?? 50); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                        ...
                        <label class="relative flex items-start p-4 rounded-2xl border border-gray-200 bg-gray-50/70 hover:bg-blue-50/40 hover:border-blue-200 cursor-pointer transition duration-150 shadow-sm dark:bg-gray-700/50 dark:border-gray-600 dark:hover:border-blue-500">
                            <div class="flex items-center h-5 mt-0.5">
                                <input type="checkbox" name="require_admin_approval" value="1" id="require_approval" <?php echo e($settings->require_admin_approval ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-500 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            </div>
                        ...
                        <label class="relative flex items-start p-4 rounded-2xl border border-gray-200 bg-gray-50/70 hover:bg-emerald-50/40 hover:border-emerald-200 cursor-pointer transition duration-150 shadow-sm dark:bg-gray-700/50 dark:border-gray-600 dark:hover:border-emerald-500">
                            <div class="flex items-center h-5 mt-0.5">
                                <input type="checkbox" name="auto_withdrawals_enabled" value="1" id="auto_withdrawals_enabled" <?php echo e(($settings->auto_withdrawals_enabled ?? false) ? 'checked' : ''); ?> class="w-5 h-5 text-emerald-600 bg-white border-gray-300 rounded focus:ring-emerald-500 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            </div>
                            <div class="ml-3.5 text-sm">
                        ...
                        <label class="relative flex items-start p-4 rounded-2xl border border-gray-200 bg-gray-50/70 hover:bg-purple-50/40 hover:border-purple-200 cursor-pointer transition duration-150 shadow-sm dark:bg-gray-700/50 dark:border-gray-600 dark:hover:border-purple-500">
                            <div class="flex items-center h-5 mt-0.5">
                                <input type="checkbox" name="validate_trc20_format" value="1" id="validate_trc20" <?php echo e($settings->validate_trc20_format ? 'checked' : ''); ?> class="w-5 h-5 text-purple-600 bg-white border-gray-300 rounded focus:ring-purple-500 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            </div>
                            <div class="ml-3.5 text-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6">
                        <div>
                            ...
                            <input type="number" min="26" max="64" name="default_trc20_min_length" value="<?php echo e($settings->default_trc20_min_length); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition">
                ...
                <div class="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-6">
                    <div>
                        ...
                        <textarea name="notes" rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition" placeholder="Record reason for modification of withdrawal limits or security toggles..."><?php echo e($settings->notes); ?></textarea>
                    </div>
