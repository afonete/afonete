  <!-- Main Footer -->
      ...
      <strong>Copyright &copy;<?php echo e(date('Y')); ?> <a href="https://bifonex.com"> Bifonex
              Ltd</a>.</strong>
      All
      rights
      reserved.
  ...
  <script src="<?php echo e(asset('assets/a/js/custom.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/footer.blade.php ENDPATH**/ ?>