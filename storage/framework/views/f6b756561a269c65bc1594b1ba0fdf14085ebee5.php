<?php $__env->startSection('contents'); ?>
    <div class="container bg-white h-screen py-4 px-3">
       ...
       <header class="bg-blue-50 py-[2rem] rounded ">
        <h1 class="text-2xl uppercase text-slate-700 font-bold"> <?php echo e($package); ?> -  INVESTORS</h1>
        ...
        <div class="flex justify-between items-center  px-3">
			...
			<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 my-3" id="myTable">
				...
				<tbody>
                    ...
                    <?php $__currentLoopData = $investors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr
						...
						<th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
							<?php echo e($deposit->user()->first()->name); ?>

						</th>

						<td class="px-6 py-4">
                            <?php echo e($deposit->user()->first()->email); ?>
						...
						<td class="px-6 py-4 uppercase">
							<?php echo e($deposit->package()->first()->name); ?>

						</td>
						<td class="px-6 py-4">
							<?php echo e(number_format($deposit->amount)); ?> $

						</td>
                        <td class="px-6 py-4">
							<?php echo e($deposit->expiration_date); ?>

						</td>


                        <td class="px-2 py-4">
                          <?php if($deposit->is_expired == '0' ): ?>
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/fc/investors.blade.php ENDPATH**/ ?>