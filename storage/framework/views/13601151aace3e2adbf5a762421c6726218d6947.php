                            ...
                            fetch("https://restcountries.com/v3.1/all")
                                ...
                                .then(data => {
                                    ...
                                    countrySelect.addEventListener('change', function() {
                                        ...
                                        const countryCode = selectedCountry ? selectedCountry.idd.root+''+selectedCountry.idd.suffixes[0] : '';
                                        countryCodeDisplay.value = countryCode ?countryCode : '';
                                        // console.log(selectedCountry.idd);
...
<?php endif; ?>
<?php /**PATH /home/cwkwkueb/test.focoin.eu/resources/views/auth/register.blade.php ENDPATH**/ ?>