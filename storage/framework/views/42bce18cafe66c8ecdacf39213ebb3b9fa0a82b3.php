...
<div class="modal fade" id="activationCode" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title " id="exampleModalLabel ">Do you have Activation Code</h5>
        <button type="button" class="btn btn-danger btn-close" data-dismiss="modal" aria-label="Close" id="btn-close">
      ...
      <div class="modal-body">
        <div class="mt-3">
            ...
            <form action="<?php echo e(route("validate")); ?>" method="POST">
                ...
                <input type="text" class="form-control my-1" placeholder="Code" placeholder="Enter Activation Code" name="code">
 ...
 <div class="modal fade" id="nonClosableModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content"  style=" background: linear-gradient(190deg, #2ecd71 60%, #27ae60 40.1%); color: black; margin: 0 auto;">


  <div class="d-flex justify-content-between p-md-2 p-3  fc_container ">
            <a href="/"><button type="button" class="btn btn-outline-info text-white btn-primary"> Back</button></a>
                 ...
                 <div class="col-md-3 mt-2">
                        <div class="mycard rounded border border-dark">
                            <div class="m-1">
                                ...
                                <div class="text-center" style="background-color:black;">
                                    ...
                                    <span style="font-size: 11px;" class="text-white" ><?php echo e($venture->percentage); ?> % </span>
                                </div>
                        ...
                        <div class="my-1 text-center">
                            <form action="<?php echo e(route('ventures')); ?>" method="post">
                                ...
                                <input type="number" name="amount_invest" placeholder=" Enter Amount ($<?php echo e(abbreviateNumber($venture->min_amount)); ?> - $<?php echo e(abbreviateNumber($venture->max_amount)); ?>)"
                 ...
                 <div class="col-md-12 col-12">
                    <div class="container">
                        ...
                        <div class="col-md-4 d-flex align-items-center justify-content-center">
                            ...
                            <a href="<?php echo e(route('user.payment.deposits')); ?>" class="btn btn-primary mx-2"   >
                                Deposit & Pay Later
                            </a>
                        </div>
                        </div>
...
<?php /**PATH /home/blackjay/Downloads/test.focoin.eu/resources/views/user/venture-package.blade.php ENDPATH**/ ?>