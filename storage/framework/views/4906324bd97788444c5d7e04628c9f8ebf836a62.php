                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="leadership_level" required class="form-select" id="leadershipLevel">
                                            <option value="TEAM_LEADER" <?php echo e(old('leadership_level', $teamLeader->leadership_level ?? 'TEAM_LEADER') === 'TEAM_LEADER' ? 'selected' : ''); ?>>TEAM LEADER</option>
                                            <option value="SUPER_LEADER" <?php echo e(old('leadership_level', $teamLeader->leadership_level ?? '') === 'SUPER_LEADER' ? 'selected' : ''); ?>>SUPER LEADER</option>
                                        </select>
                                    </div>
