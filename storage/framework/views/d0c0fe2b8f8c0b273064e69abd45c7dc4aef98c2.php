            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                  <li class="p-0">
                   ...
                   <li class="nav-item has-treeview ">
                    <a href="<?php echo e(route('user.buypackage')); ?>" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="<?php echo e(route('overview')); ?>" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(route('staker-package')); ?>" class="nav-link">
                            <img src="https://cdn-icons-png.flaticon.com/256/7544/7544957.png" style=" display:inline-block; vertical-align:middle;">
                            <span class="push" style="display:inline-block; vertical-align:middle;">Staker Package</span>
                        </a>
                        <?php endif; ?>
...
<?php //{{route('user.dashboard.create')}} ?>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <?php if($user->has_free_package == 'yes' ||$user->has_free_package == 'yes'): ?>
                        <a href="<?php echo e(route('user.dashboard.freeaccount-restricted')); ?>" class="nav-link">
                            <img src="https://cdn-icons-png.flaticon.com/256/7544/7544957.png" style="display:inline-block;vertical-align:middle">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="<?php echo e(route('teambuilding')); ?>" class="nav-link ">  <!-- teambuilding -->
                            <i class="nav-icon fas fa-users"></i>
                            <p>
                                team Building
                            </p>
                    ...
                    <li class="nav-item has-treeview">
                        <?php if($user->has_free_account || $isFree): ?>
                           <a href="<?php echo e(route('user.dashboard.freeaccount-restricted')); ?>" class="nav-link">
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\mcu.focoin.eu\resources\views/user/user-dashboard-base.blade.php ENDPATH**/ ?>