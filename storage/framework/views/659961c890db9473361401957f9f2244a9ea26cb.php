    ...
    <div class="grid">
        <div class="card">
            ...
            <div class="card-b" style="text-align:center;">
                <img class="qr" src="<?php echo e($qrUrl); ?>" alt="USDT TRC20 payment QR code">
        ...
        <div class="card">
            <div class="card-h">
                <span id="statusBadge" class="pill <?php echo e($deposit->status === 'approved' ? 'approved' : ($isExpired ? 'expired' : 'pending')); ?>">
                    <?php echo e($isExpired && $deposit->status === 'pending' ? 'EXPIRED' : strtoupper($deposit->status)); ?>
