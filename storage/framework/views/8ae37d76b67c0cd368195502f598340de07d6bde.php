    ...
    <div class="container-fluid">
            ...
            <div class="alert alert-warning border-0 shadow-sm rounded-lg p-4 mb-4" style="background-color: #fffbe3; border-left: 5px solid #f59e0b !important;">
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('investment-package')); ?>" class="btn btn-warning font-weight-bold px-4 rounded-pill shadow-sm text-dark">
        ...
        <div class="card border-0 shadow-sm rounded-lg overflow-hidden mb-4">
            ...
            <div class="card-body p-4 bg-white">
                    ...
                    <div class="alert alert-success d-flex align-items-center rounded-lg border-0 shadow-sm p-3" style="background-color: #d1fae5; border-left: 5px solid #10b981 !important;">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-dark text-sm">
                                ...
                                <strong><?php echo e($user->affiliate_terms_accepted_at ? \Carbon\Carbon::parse($user->affiliate_terms_accepted_at)->format('M d, Y \a\t H:i') : 'Active'); ?></strong>. 
                ...
                <?php else: ?>
                    <?php if($hasFomPackage): ?>
                        <form action="<?php echo e(route('user.affiliate.accept-terms')); ?>" method="POST" id="affiliateTermsPageForm">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/affiliate-terms.blade.php ENDPATH**/ ?>