...
<div class="container mx-auto py-6 px-6 bg-slate-50 min-h-screen">
    ...
    <div class="bg-white border border-slate-200 rounded-xl px-5 py-4 mb-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <a href="<?php echo e(route('admin.fom-licence-miner.index')); ?>" class="bg-amber-500 text-white font-bold py-2 px-3 rounded-lg text-xs shadow-sm transition-all">
                <i class="fas fa-box"></i> Manage Plans
            </a>
            <a href="<?php echo e(route('admin.fom-licence-miner.codes')); ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold py-2 px-3 rounded-lg text-xs transition-all">
                <i class="fas fa-ticket-alt"></i> Code Usage
            </a>
            <a href="<?php echo e(route('admin.fom-licence-miner.escrow-audit')); ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold py-2 px-3 rounded-lg text-xs transition-all">
                <i class="fas fa-shield-alt"></i> Escrow &amp; Staking Audit
            </a>
            <a href="<?php echo e(route('admin.fom-licence-miner.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-3.5 rounded-lg shadow-sm transition-all flex items-center gap-1.5 text-xs ms-2">
