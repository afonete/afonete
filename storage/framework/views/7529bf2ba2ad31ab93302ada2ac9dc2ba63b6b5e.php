  ...
  <script src="<?php echo e(asset('assets/a/dist/js/pages/dashboard3.js')); ?>"></script>
    <script  src="<?php echo e(asset('assets/a/js/custom.js')); ?>" ></script><?php /**PATH C:\xampp\htdocs\KANANI\BIFONEX\mcu.focoin.eu\resources\views/user/footer.blade.php ENDPATH**/ ?>