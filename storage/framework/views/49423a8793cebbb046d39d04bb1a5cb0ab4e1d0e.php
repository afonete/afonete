    ...
    <div class="grid grid-cols-2 sm:grid-cols-7 gap-3
        mt-[1rem] container  mx-auto ">
            ...
            <div>
                ...
                <h1 class="text-slate-500 font-bold pt-2"><?php echo e(number_format($remainingLiquidityPool, 0, '.', ' ')); ?> Token</h1>
            </div>
        ...
        <div class="card  rounded border-l-[4px] border-blue-400 bg-white flex  items-center  rounded shadow-sm px-2 justify-between py-5">
            ...
            <h1 class="text-slate-500 font-bold pt-2"><?php echo e(number_format($totalCoinSales, 0, '.', ' ')); ?> Token</h1>
            </div>
            ...
            <div>
                ...
                <h1 class="text-slate-500 font-bold pt-2"><?php echo e(number_format($remainingTotalSupply, 0, '.', ' ')); ?> Token</h1>
            </div>
            ...
            <ul role="list" class=" px-3  py-2 bg-indigo-200 block sm:grid grid-cols-3 gap-3">
              ...
              <li class="  bg-white py-5 px-2  text-xs  my-2 lg:my-auto">
                <div class="cards">
                  ...
                  <div class="middle flex justify-between gap-3 w-full items-center pb-2 ">
                    <h2 class="text-lg font-bold text-slate-800"><?php echo e(number_format($totalDepositAllTime, 2)); ?> USD</h2>
                      <div class="indicator flex gap-1 <?php echo e($depositPct >= 0 ? 'text-green-500' : 'text-red-500'); ?> font-bold">
                        <p>
                          <i class="fa-solid <?php echo e($depositPct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                          <i class="fa-solid <?php echo e($depositPct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                        </p>
                        <p><?php echo e(number_format(abs($depositPct), 0)); ?>%</p>
                      </div>
                  </div>
                  <div class="down flex gap-2 uppercase items-end justify-between">
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Month</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($totalDepositThisMonth, 2)); ?> USD</p>
                      </div>
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Week</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($totalDepositThisWeek, 2)); ?> USD</p>
                      </div>
              ...
              <li class="  bg-white py-5 px-2  text-xs my-2 lg:my-auto">
                <div class="cards">
                  ...
                  <div class="middle flex justify-between gap-3 w-full items-center pb-2 ">
                    <h2 class="text-lg font-bold text-slate-800"><?php echo e(number_format($totalWithdrawAllTime, 2)); ?> USD</h2>
                      <div class="indicator flex gap-1 <?php echo e($withdrawPct >= 0 ? 'text-green-500' : 'text-red-500'); ?> font-bold">
                        <p>
                          <i class="fa-solid <?php echo e($withdrawPct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                          <i class="fa-solid <?php echo e($withdrawPct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                        </p>
                        <p><?php echo e(number_format(abs($withdrawPct), 0)); ?>%</p>
                      </div>
                  </div>
                  <div class="down flex gap-2 uppercase items-end justify-between">
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Month</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($totalWithdrawThisMonth, 2)); ?> USD</p>
                      </div>
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Week</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($totalWithdrawThisWeek, 2)); ?> USD</p>
                      </div>
                      <div class="simple-chart  flex justify-center ">
              ...
              <li class="  bg-white py-5 px-2  text-xs">
                <div class="cards">
                  ...
                  <div class="middle flex justify-between gap-3 w-full items-center pb-2 ">
                    <h2 class="text-lg font-bold text-slate-800"><?php echo e(number_format($totalAvailableBalance, 2)); ?> USD</h2>
                      <div class="indicator flex gap-1 <?php echo e($availablePct >= 0 ? 'text-green-500' : 'text-red-500'); ?> font-bold">
                        <p>
                          <i class="fa-solid <?php echo e($availablePct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                          <i class="fa-solid <?php echo e($availablePct >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> text-xs "></i>
                        </p>
                        <p><?php echo e(number_format(abs($availablePct), 0)); ?>%</p>
                      </div>
                  </div>
                  <div class="down flex gap-2 uppercase items-end justify-between">
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Month</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($availableThisMonth, 2)); ?> USD</p>
                      </div>
                      <div>
                        <h2 class="pb-1 font-semibold text-slate-500">This Week</h2>
                        <p class="text-slate-800 font-bold" style="font-size: 0.8rem;"><?php echo e(number_format($availableThisWeek, 2)); ?> USD</p>
                      </div>
                      <div class="simple-chart  flex justify-center ">
...
<?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/admin-dashboard.blade.php ENDPATH**/ ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/admin/admin-dashboard.blade.php ENDPATH**/ ?>