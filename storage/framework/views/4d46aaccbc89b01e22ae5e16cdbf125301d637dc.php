...
<div class="container-fluid py-4">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 text-center"><div class="card-body">
                ...
                <input type="text" class="form-control form-control-sm mt-1" readonly
                       value="<?php echo e(url('/register?ref=' . urlencode('REF-' . strtoupper(base_convert((string)auth()->id(), 10, 36)) . '-' . substr(md5(auth()->user()->email), 0, 6)))); ?>">
    ...
    <div class="card shadow-sm border-0 mt-3">
        ...
        <div class="card-body p-0">
            ...
            <div class="p-3"><?php echo e($directs->links()); ?></div>
            <?php endif; ?>
        </div>
    </div>
