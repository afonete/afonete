...
<form action="<?php echo e(route('admin.check')); ?>" method="post" class="validate-form">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\mcu.focoin.eu\resources\views/admin/login.blade.php ENDPATH**/ ?>