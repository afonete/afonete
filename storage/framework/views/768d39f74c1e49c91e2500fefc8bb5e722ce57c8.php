...
<div class="card">
    <div class="head">
        <span id="statusBadge" class="pill <?php echo e($isExpired ? 'expired' : $deposit->status); ?>">
            <?php echo e($isExpired ? 'EXPIRED' : strtoupper($deposit->status)); ?>
    ...
    <div class="body">
        <?php if(session('message')): ?>
            <div class="alert info"><?php echo e(session('message')); ?></div>
        <?php endif; ?>

        <div class="grid">
            <div class="box">
                <div class="label">Reference</div>
                <div class="value" style="font-size:14px; word-break:break-all;"><?php echo e($deposit->transaction_id); ?></div>
            </div>
            <div class="box">
                <div class="label">Amount</div>
                <div class="value">$<?php echo e(number_format($deposit->amount_deposited, 2)); ?> <?php echo e($deposit->currency_type); ?></div>
            </div>
            <div class="box">
                <div class="label">Method</div>
                <div class="value"><?php echo e($deposit->deposit_method); ?></div>
            </div>
            <div class="box">
                <div class="label">Submitted</div>
                <div class="value"><?php echo e($deposit->created_at->format('Y-m-d H:i')); ?></div>
            </div>
        </div>
        ...
        <div id="expiredBox" class="alert warn" style="<?php echo e($isExpired ? '' : 'display:none;'); ?>">
        ...
        <div class="actions">
            ...
            <a class="btn btn-dark" href="<?php echo e(route('user.manual-deposit')); ?>">Create another deposit</a>
            <a class="btn btn-dark" href="<?php echo e(route('user.venture')); ?>">Back to packages</a>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/user/manual-deposit-waiting.blade.php ENDPATH**/ ?>