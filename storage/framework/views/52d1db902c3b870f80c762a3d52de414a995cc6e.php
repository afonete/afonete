...
<div class="container-fluid py-4 px-4 bg-slate-50 min-h-screen">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-2 overflow-x-auto pb-1 text-xs font-bold">
            ...
            <a href="<?php echo e(route('admin.kyc.index', ['filter' => 'level1'])); ?>" class="px-3.5 py-2 rounded-xl border transition <?php echo e(request('filter') === 'level1' ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-50'); ?>">
                Level 1 Pending
            </a>
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $verifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="py-4 px-4">
                                <?php if($v->level_1_status === 'approved'): ?>
                                ...
                                <?php elseif($v->level_1_status === 'pending'): ?>
                                ...
                                <?php elseif($v->level_1_status === 'rejected'): ?>
