...
?>
        ...
        <div class="ad-main-box mt-3 mb-3">
             ...
             <div class="ad-sub-box2">
                ...
                <div class="sub-box-1">
                         <div class=" ad-box bg-success ">
                                <a class="nav-icon fas fa-gift" href="#"><br>Wallet  Balance <br> coming soon</a>
                         </div>
                        <?php if($user->has_free_package == 'no'): ?>
                     ...
                     <a href="<?php echo e(route('user.referral.show')); ?>">
                         <div class="info-box mb-3">
                             ...
                             <div class="info-box-content">
                                 ...
                                 <span class="info-box-number"><?php echo e(count($referrals)+$left+$right); ?></span>
                             </div>
  ...
  <?php endif; ?>
                                            ...
                                            <?php if($package!='standard'): ?>
                                               <button class="btn btn-info  "  onclick="copyToClipboard('link-right')">
                                                ...
                                                value="http://127.0.0.1:8000/register?referral=<?php echo e($ref_code); ?>&side=RIGHT"
                                              class="form-control" readonly class="form-control">
                                              ...
                                              <?php else: ?>
                                                <input type="text" id="link-right"value="http://fonepo.com/register?referral=*******"
                                              class="form-control" readonly class="form-control"><?php endif; ?>
                                            ...
                                            <?php if($package!='standard'): ?>
                                              <button class="btn btn-primary"  onclick="copyToClipboard('link-right')">
                                                ...
                                                <input type="text" id="link-left" value="http://127.0.0.1:8000/register?referral=<?php echo e($ref_code); ?>&side=LEFT"
                                              class="form-control" readonly class="form-control">
                                              ...
                                              <?php else: ?>
                                                <input type="text" id="link-left"value="http://fonepo.com/register?referral=*******"
                                              class="form-control" readonly class="form-control"><?php endif; ?>
...
<?php /**PATH /home/blackjay/Downloads/test.focoin.eu/resources/views/user/dashboard.blade.php ENDPATH**/ ?>