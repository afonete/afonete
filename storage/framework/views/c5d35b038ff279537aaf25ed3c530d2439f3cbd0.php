...
<div class="container mt-4">
  <div class="row">
      ...
      <div class="card shadow">
        ...
        <div class="card-body text-center">
          <p class="text-muted">Our newest site! Already 3 years old!</p>
           <div class="my-1">
            <img src="<?php echo e(asset('image/usd.jpg')); ?>" class="img-fluid rounded" alt="OptimalBux" style="max-width: 130px; height: auto;">
          </div>
    ...
    <?php echo $__env->make('user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/user/fearloss/fixedads.blade.php ENDPATH**/ ?>