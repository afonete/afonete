    ...
    <div class="fd-flex justify-content-around align-self-center">
        ...
        <div class="text-center" style="width: 80%">
            <div class="card-body">
                ...
                <p class="card-text"> Your request to join Bifonex on <u><?php echo e($email); ?></u> has been accepted and it is on waiting. You will receive acceptance email once you will be accepted. This action takes 2hr-48hr normal.
            </div>
        ...
        <div class="text-center" style="width: 80%; max-width: 500px; margin: 0 auto; background: #fff; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
            <div class="card-body">
                ...
                <p class="card-text text-sm text-gray-600 mb-4 leading-relaxed">
                    Thanks for signing up! We have sent a **6-digit Activation PIN** to your email address <u><?php echo e($email); ?></u>. 
                    Please enter the code below to instantly verify and activate your account.
                </p>

                
                <form method="POST" action="<?php echo e(route('verification.verify-pin')); ?>" class="mb-4">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-4 d-flex justify-content-center align-items-center gap-3 border-top pt-3" style="border-color: #f1f5f9;">
                <form method="POST" action="<?php echo e(route('verification.resend-pin')); ?>">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\bifonepo\mcu.focoin.eu\afonete\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>