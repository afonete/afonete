  ...
  <?php echo $__env->make('home.include.leadersnav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="relative z-10 ">
        <h1 class="bg-clip-text text-transparent bg-gradient-to-r from-blue-400  via-orange-500 to-purple-500  md:text-4xl text-2xl font-bold text-center my-20 ">
            ...
            Become an  <?php echo e(env('APP_NAME')); ?> Social Ambassador
...
<!-- about who can be ambassador -->
    ...
    <div>
            <div class="flex justify-center items-center h-full w-full">
                <div class="">
            <h1 class="text-2xl text-blue-950 font-medium my-1">The <?php echo e(env('APP_NAME')); ?> Ambassador Program  </h1>

            <p class="">
            These active individuals drive adoption by going beyond their duties by making timely, 
            consistent, and useful contributions to the project. These special people are <?php echo e(env('APP_NAME')); ?> ambassadors.
            </p>
            </div>
            </div>    </div>
    ...
    <div class="">
        <div class="flex justify-between items-center cursor-pointer collapsible-header">
            <h1 class="text-2xl text-blue-950 font-medium">What is <?php echo e(env('APP_NAME')); ?> Ambassador Program</h1>
            <i class="fa fa-plus font-bold transform transition-transform duration-200"></i>
        </div>
        <div class="content hidden mt-4">
            <p>
        <?php echo e(env('APP_NAME')); ?> Ambassadors Program is created for our community members, who are willing to 
        ...
        be assigned by the <?php echo e(env('APP_NAME')); ?> Team every month.
            </p>
        </div>
    </div>
    ...
    <div class="">
        <div class="flex justify-between items-center cursor-pointer collapsible-header">
            <h1 class="text-2xl text-blue-950 font-medium">Who are <?php echo e(env('APP_NAME')); ?> Ambassadors?</h1>
            <i class="fa fa-plus font-bold transform transition-transform duration-200"></i>
        </div>
        <div class="content hidden mt-4">
            <p>
   ...
   <div class="text-center my-10 mx-5">
    <h1 class="font-bold text-xl text-blue-800">The <?php echo e(env('APP_NAME')); ?> Ambassadors Programs is create for our community members, 
...
<?php /**PATH /home/cwkwkueb/mcu.focoin.eu/resources/views/home/ambassador.blade.php ENDPATH**/ ?>