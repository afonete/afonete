...
<div class="container-fluid py-4 px-4">
    ...
    <?php if(session('message')): ?>
        <div class="alert alert-success alert-dismissible fade show"><?php echo e(session('message')); ?><button class="close" data-dismiss="alert">&times;</button></div>
    <?php endif; ?>
    <?php if($errors->any()): ?>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        <tr><td class="text-muted">Symbol</td><td class="font-weight-bold"><span class="badge badge-info"><?php echo e($s->token_symbol); ?></span></td></tr>
                        <tr class="border-top"><td colspan="2" class="text-muted small pt-2">Token Prices</td></tr>
                        <tr><td class="text-muted">UVP Purchase</td><td class="font-weight-bold">$<?php echo e(number_format($s->uvp_price,6)); ?></td></tr>
                        <tr><td class="text-muted">Renewal (30-day)</td><td class="font-weight-bold">$<?php echo e(number_format($s->renewal_price,6)); ?></td></tr>
                        <tr><td class="text-muted">Swap</td><td class="font-weight-bold">$<?php echo e(number_format($s->swap_price,6)); ?></td></tr>
                        <tr><td class="text-muted">Trading <small class="text-muted">(reserved)</small></td><td class="font-weight-bold">$<?php echo e(number_format($s->trading_price,6)); ?></td></tr>
                        <tr><td class="text-muted">Package <small class="text-muted">(reserved)</small></td><td class="font-weight-bold">$<?php echo e(number_format($s->package_price,6)); ?></td></tr>
                        <tr class="border-top"><td class="text-muted">Coin Value</td><td class="font-weight-bold text-success">$<?php echo e(number_format($s->coin_value,6)); ?></td></tr>
                    </table>
                    <hr>
                    <p class="text-muted small mb-1">Example — $1,000 investment at UVP price:</p>
                    <?php $ex = $s->uvp_price > 0 ? 1000/$s->uvp_price : 0; ?>
                    <p class="mb-0"><strong><?php echo e(number_format($ex,0)); ?></strong> <?php echo e($s->token_symbol); ?> locked tokens</p>
                    <p class="text-muted small">Swap 1,000 tokens → $<?php echo e(number_format(1000*$s->swap_price,2)); ?> cashout
                        <small class="text-muted">(uses <code>swap_price</code>; <code>coin_value</code> is display-only)</small>
                    </p>
                    <p class="text-muted small mb-0">Last updated: <?php echo e($s->updated_at->format('d M Y H:i')); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="token_symbol" class="form-control" value="<?php echo e(old('token_symbol', $setting->token_symbol ?? 'FONE')); ?>" required maxlength="20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="coin_value" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('coin_value', $setting->coin_value ?? '0.002000')); ?>" required></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                    <input type="number" name="uvp_price" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('uvp_price', $setting->uvp_price ?? '0.002500')); ?>" required></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                    <input type="number" name="renewal_price" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('renewal_price', $setting->renewal_price ?? '0.002500')); ?>" required></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                    <input type="number" name="swap_price" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('swap_price', $setting->swap_price ?? '0.002000')); ?>" required></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                    <input type="number" name="trading_price" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('trading_price', $setting->trading_price ?? '0.002500')); ?>"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                    <input type="number" name="package_price" class="form-control" step="0.000001" min="0.000001" value="<?php echo e(old('package_price', $setting->package_price ?? '0.002500')); ?>"></div>
