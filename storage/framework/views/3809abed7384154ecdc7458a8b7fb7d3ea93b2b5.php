                        ...
                        <div class="pt-3 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div class="space-y-2.5 text-sm">
                                <div class="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg dark:bg-gray-700/50">
                                    ...
                                    <span class="font-bold font-mono text-gray-900 dark:text-white"><?php echo e(number_format($s->initial_supply ?? 120000000000, 0, '.', ' ')); ?></span>
                                </div>
                                <div class="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg dark:bg-gray-700/50">
                                    <span class="text-gray-600 dark:text-gray-300">Configured Liquidity Pool</span>
                                    <span class="font-bold font-mono text-gray-900 dark:text-white"><?php echo e(number_format($s->initial_liquidity ?? 40000000000, 0, '.', ' ')); ?></span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="sm:col-span-2 bg-indigo-50/40 p-4 rounded-xl border border-indigo-100 dark:bg-indigo-900/10 dark:border-indigo-800/50 mt-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div class="flex rounded-xl shadow-sm">
                                                <input type="number" name="initial_supply" min="0" step="1" value="<?php echo e(old('initial_supply', $setting->initial_supply ?? '120000000000')); ?>" required class="rounded-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm p-3 font-mono font-bold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition duration-150">
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex rounded-xl shadow-sm">
                                                <input type="number" name="initial_liquidity" min="0" step="1" value="<?php echo e(old('initial_liquidity', $setting->initial_liquidity ?? '40000000000')); ?>" required class="rounded-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm p-3 font-mono font-bold dark:bg-gray-700 dark:border-gray-600 dark:text-white transition duration-150">
                                            </div>
