...
<body>@if($package=="standard")
    ...
    <p>Your account has been directly activated to Free account.This is individual email<br> from Bifonex
    ...
    <p>enter this code <b><u>{{$activation}}</u></b> to activate your package.This is individual email from Bifonex
        don't share it.</p>
    <p>thank u</p>
    @endif
