    ...
    @endif
            ...
            <form action="{{route("admin.adventures.store")}}" method="POST" class="block sm:grid grid-cols-3 gap-3">
                @csrf
                    ...
                    {{-- <div>
                        <label for="percentage_earning" class="block text-sm font-medium text-gray-700  pb-2">Percentage Min (%): </label>
                        <input type="number" step="0.01"
                        name="minpercent" placeholder="Ex:  1.5%" class=" block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                    </div> --}}
                ...
                <div>
                    ...
                    <input type="number" id="min_amount" name="min_amount"
                     class=" block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring
                      focus:ring-blue-500 focus:ring-opacity-50" required placeholder="Ex: 19000$" value="{{old('min_amount')}}">
                </div>
                <div>
                    ...
                    class=" block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring
                     focus:ring-blue-500 focus:ring-opacity-50" required placeholder="Ex: 400000$" value="{{old('max_amount')}}">
                </div>
                ...
                <div>
                    ...
                    class=" block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring
                    focus:ring-blue-500 focus:ring-opacity-50" required placeholder="Ex: 100 days" value="{{old('duration')}}">
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="total_return" name="total_return"
                     class=" block w-full border-gray-300 rounded-md shadow-sm
                      ...
                      placeholder="EX: 130%" value="{{old('total_return')}}">
                </div>
