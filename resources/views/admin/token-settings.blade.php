...
<div class="container mx-auto py-6 px-4 sm:px-6 lg:px-8 max-w-7xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {{-- Current Values Card (Left Column - 4 cols on lg) --}}
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <span class="bg-blue-100 text-blue-800 text-xs font-bold px-3 py-1 rounded-full dark:bg-blue-900 dark:text-blue-300 border border-blue-200">{{ $s->token_symbol }}</span>
                        </div>
                        ...
                        <div class="pt-1">
                            ...
                            <div class="space-y-2.5 text-sm">
                                <div class="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg dark:bg-gray-700/50">
                                    ...
                                    <span class="font-bold font-mono text-gray-900 dark:text-white">${{ number_format($s->uvp_price, 6) }}</span>
                                </div>
                                <div class="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg dark:bg-gray-700/50">
                                    <span class="text-gray-600 dark:text-gray-300">Renewal <span class="text-xs text-gray-400">(30-day)</span></span>
                                    <span class="font-bold font-mono text-gray-900 dark:text-white">${{ number_format($s->renewal_price, 6) }}</span>
                                </div>
                                <div class="flex justify-between items-center bg-blue-50/60 p-2.5 rounded-lg border border-blue-100 dark:bg-blue-900/20 dark:border-blue-800">
                                    ...
                                    <span class="font-bold font-mono text-blue-700 dark:text-blue-400">${{ number_format($s->swap_price, 6) }}</span>
                                </div>
                                <div class="flex justify-between items-center p-2.5 rounded-lg text-gray-400">
                                    ...
                                    <span class="font-mono">${{ number_format($s->trading_price, 6) }}</span>
                                </div>
                                <div class="flex justify-between items-center p-2.5 rounded-lg text-gray-400">
                                    <span>Package <small class="text-xs italic">(reserved)</small></span>
                                    <span class="font-mono">${{ number_format($s->package_price, 6) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-2">
                            ...
                            <div class="flex justify-between items-center bg-emerald-50 p-3 rounded-xl border border-emerald-100 dark:bg-emerald-900/20 dark:border-emerald-800">
                                ...
                                <span class="font-extrabold font-mono text-emerald-600 text-base dark:text-emerald-400">${{ number_format($s->coin_value, 6) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100 dark:border-gray-700">
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-200 text-xs text-slate-600 dark:bg-slate-700/50 dark:border-slate-600 dark:text-slate-300 space-y-2">
                            ...
                            <p class="leading-relaxed">
                                ...
                                <span class="text-blue-600 font-bold font-mono text-sm dark:text-blue-400">{{ number_format($ex, 0) }}</span> <span class="font-semibold">{{ $s->token_symbol }}</span> locked tokens.
                            </p>
                            <p class="leading-relaxed pt-1 border-t border-slate-200 dark:border-slate-600">
                                Swapping 1,000 tokens &rarr; <span class="font-bold text-emerald-600 dark:text-emerald-400">${{ number_format(1000*$s->swap_price, 2) }}</span> cashout.<br>
                        ...
                        <p class="text-slate-400 text-[11px] mt-3 text-right flex items-center justify-end gap-1">
                            <i class="far fa-clock"></i> Last updated: {{ $s->updated_at->format('d M Y, H:i') }}
                        </p>
                    </div>
                    @else
        ...
        {{-- Update Form Card (Right Column - 8 cols on lg) --}}
        <div class="lg:col-span-8">
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('admin.token-settings.update') }}" class="space-y-6">
                        @csrf @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="token_symbol" value="{{ old('token_symbol', $setting->token_symbol ?? 'FONE') }}" required maxlength="20" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 font-semibold dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white transition duration-150">
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm">
                                        ...
                                        <input type="number" name="coin_value" step="0.000001" min="0.000001" value="{{ old('coin_value', $setting->coin_value ?? '0.002000') }}" required class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white transition duration-150">
                                    </div>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm">
                                        <span class="inline-flex items-center px-4 text-sm font-bold text-gray-500 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">$</span>
                                        <input type="number" name="uvp_price" step="0.000001" min="0.000001" value="{{ old('uvp_price', $setting->uvp_price ?? '0.002500') }}" required class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white transition duration-150">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm">
                                        <span class="inline-flex items-center px-4 text-sm font-bold text-gray-500 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">$</span>
                                        <input type="number" name="renewal_price" step="0.000001" min="0.000001" value="{{ old('renewal_price', $setting->renewal_price ?? '0.002500') }}" required class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 font-mono font-semibold dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white transition duration-150">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm opacity-80">
                                        ...
                                        <input type="number" name="trading_price" step="0.000001" min="0.000001" value="{{ old('trading_price', $setting->trading_price ?? '0.002500') }}" class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-600 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 font-mono dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm opacity-80">
                                        <span class="inline-flex items-center px-4 text-sm text-gray-400 bg-gray-100 border border-r-0 border-gray-300 rounded-l-xl dark:bg-gray-700 dark:border-gray-600">$</span>
                                        <input type="number" name="package_price" step="0.000001" min="0.000001" value="{{ old('package_price', $setting->package_price ?? '0.002500') }}" class="rounded-none rounded-r-xl bg-gray-50 border border-gray-300 text-gray-600 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-3 font-mono dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                    </div>
                                    <p class="mt-1.5 text-xs text-gray-400 flex items-center gap-1">
