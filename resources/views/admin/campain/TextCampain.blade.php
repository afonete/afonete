                ...
                <div >
                    ...
                    <div class="border  rounded-lg self-start my-2">
                        ...
                        <div class="mb-4 px-3 py-2">
                            ...
                            {{-- <div x-data="{ userInput: '' }" class="p-4">
                                <label for="input" class="block mb-2 font-semibold">Type something:</label>
                                <input type="text" id="input" x-model="userInput"
                                       class="border border-gray-300 px-3 py-2 rounded-md w-full" placeholder="Start typing..." />

                                <p class="mt-4 text-lg font-semibold text-gray-700">You typed: <span x-text="userInput"></span></p>
                            </div> --}}
                ...
                <div>
                    ...
                    <div class="max-w-3xl mx-auto bg-gray-900 text-gray-300 p-6 rounded-lg shadow-lg">
                        ...
                        <p class="text-sm mb-4">
                            ...
                            <a href="{{route('user.dashboard.deposit')}}" class="text-red-500 underline">Deposit</a> to add Coins to your balance.
                        </p>
