...
<div class=" mx-auto">
	...
	<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        {{-- <button id='pending' class="px-2 bg-gray-100 py-1 rounded ">Sort by Pending</button>
        <button id='cancelled' class="px-2 bg-gray-100 py-1 rounded ">Sort by Cancelled</button>
        <button id='approved' class="px-2 bg-gray-100 py-1 rounded ">Sort by Approved</button> --}}
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 status">
                          ...
                          $color = "";
                           ...
                           ?> rounded-2xl text-white"> {{ucfirst($deposit->status)}}  </span>
                            ...
                            <div class="relative inline-block ">
                                ...
                                w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none ">
                                    <div class="flex flex-col uppercase text-left p-1">
                                      ...
                                      <button class="uppercase py-2 text-gray-600 hover:bg-gray-100 rounded hover:shadow flex gap-2 px-2 items-center w-full" onclick="show('under-review','{{$deposit->id}}')">
                                        <i class="fa fa-hourglass-half"></i> <span>Under Review</span>
                                      </button>
                                      @endif

                                      @if($deposit->status != 'rejected')
                                      <button class="uppercase py-2 text-yellow-600 hover:bg-yellow-100 rounded hover:shadow flex gap-2 px-2 items-center w-full" onclick="show('rejected','{{$deposit->id}}')">
                                        <i class="fa fa-ban"></i>
                                        <span>Reject</span>
                                      </button>
                                      @endif
                                      ...
                                      <button class="uppercase py-2 text-red-500 hover:bg-red-50 flex gap-2 px-2 items-center w-full hover:shadow" onclick="show('cancelled','{{$deposit->id}}')">
