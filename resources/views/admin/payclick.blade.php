    ...
    <div class="container mx-auto">
        ...
        <div class="tabs mt-2">
            <div class="flex space-x-4">
                <a href="{{ route('admin.ads') }}" class="fomoLink flex items-center space-x-1 font-bold text-gray-900">
                    <i class="fa-solid fa-rectangle-ad font-bold"></i>
                    <span>Manage ads</span>
                </a>
                <a href="{{ route('admin.ads.create') }}" class="fomoLink flex items-center space-x-1 font-bold text-gray-900">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
            <div class="bg-white shadow rounded p-4 flex items-center">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600">Advertisement: {{ count($ads) }}</div>
                </div>
            </div>
            <a href="#" class="bg-white shadow rounded p-4 flex items-center">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600">Advertisement: {{ $accepted }}</div>
                </div>
            </a>
            <a href="#" class="bg-white shadow rounded p-4 flex items-center">
                ...
                <div>
                    ...
                    <div class="text-sm text-gray-600">Advertisement: {{ $rejected }}</div>
                </div>
            </a>
        </div>
        ...
        <div class="table-container my-4 bg-white shadow rounded">
            <div class="p-4 border-b">
                <p class="text-center font-bold text-xl">All advertisements <span class="text-green-700">{{ count($ads) }}</span></p>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-200 text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            <td class="py-2 px-4 border-r">{{ $i++ }}</td>
                            <td class="py-2 px-4 border-r">{{ $ad->tittle }}</td>
                            <td class="py-2 px-4 border-r">{{ $ad->description }}</td>
                            <td class="py-2 px-4 border-r">{!! $status !!}</td>
                            <td class="py-2 px-4 border-r">{{ $ad->user }}</td>
                            <td class="py-2 px-4">
                                <div class="relative inline-block text-left">
                                    ...
                                    <div class="absolute right-0 w-48 py-2 mt-2 bg-white rounded-md shadow-xl hidden" id="drop-content">
                                        <a href="{{ route('admin.adsDetail') }}?id={{ $ad->id }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-400 hover:text-white">View</a>
