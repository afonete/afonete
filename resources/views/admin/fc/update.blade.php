...
@section('contents')
    <div class="container bg-white h-screen py-4 px-3">
       ...
       <header class="bg-blue-50 py-[2rem] rounded ">
        <h1 class="text-2xl uppercase text-slate-700 font-bold">FC PACKAGE- EDIT ({{$adventure->name}})</h1>
...
<div class=" mx-auto">
    ...
    <form action="{{ route('fcpackages.update', $adventure->id) }}" method="POST" class="flex flex-col gap-3 w-full sm:w-1/2 mx-auto">
        @csrf
        @method('PUT')
