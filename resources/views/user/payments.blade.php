       ...
       <x-PaymentNav/>
        ...
        <div class="border px-4 py-4 rounded-lg my-4">
            <div class="flex justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <h1 class="text-gray-500" id="balance">{{$cashout}}</h1>
        ...
        <div class="block sm:grid grid-cols-2 my-2 gap-2">
            ...
            <div class="bg-white p-4 flex flex-col rounded-lg my-2 sm:my-0">
                ...
                @endif
                <hr/>
                <form class="flex gap-2 flex-wrap " action="{{route('transfer-totrading')}}" method="POST">
                    @csrf
                    @method('POST')
                    <div class="border  flex justify-center  rounded-lg p-0">
                        <input type="number" name="amount" placeholder="Amount.." class="px-2 py-2 " max="{{$cashout}}" required step="0.01"/>
                        <div class="bg-gray-800  px-2 flex  items-center text-white">$</div>
                    </div>
            ...
            <div class="bg-white p-4 flex flex-col rounded-lg my-2 sm:my-0">
                ...
                <hr/>
                <form class="flex gap-2  flex-wrap" method="POST" action="{{route('transferToAccount')}}" id="transferForm">
                    @csrf
                    @method('POST')
                                ...
                                <div class="py-3 px-3 border rounded">
                                    ...
                                    <div class="grid grid-cols-4 gap-2">
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/pancake.jpeg")}}"
                                            style="width:60px;height:60px;object-fit:cover" class="rounded-circle">
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/okx.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/exchange.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/kucoin.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/yo.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/bybit.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/binance.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>

                                        </div>
                                        <div class=" py-3 px-2 text-center rounded block">
                                            <img src="{{asset("image/bitcoin.jpeg")}}" style="width:60px;height:60px;object-fit:cover" class=" rounded-circle"/>
                                        </div>
