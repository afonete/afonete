...
<div class="content">
    <div class="container-fluid py-4 text-left">
        ...
        <div id="reward-button" class="d-none mb-4 text-center">
            ...
            <a href="{{route('user.asking')}}?url={{$url}}&ads={{$id}}" class="btn btn-warning font-weight-bold py-2 px-4">
                Claim Reward {{$earn}}$
            </a>
        ...
        <div class="embed-responsive embed-responsive-16by9 shadow-sm rounded mb-4">
            <iframe src="{{$url}}" class="embed-responsive-item border-0" title="Embedded Content"></iframe>
        </div>
    </div>
