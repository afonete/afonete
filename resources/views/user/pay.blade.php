...
<div class="row min-h-screen grid grid-cols-5 justify-content-center gap-3 justify-center p-3">
    <div class="warning  shadow rounded px-4 py-4 col-span-3">
        ...
        <div class="rules flex flex-col gap-3">
                  <div>
                <img src="{{asset('assets/a/img/warning.png')}}" alt="">
            ...
            <!--</div>-->
             <div> <img src="{{asset('assets/a/img/warning.png')}}" alt="">
    ...
    <div class=" col-span-2 ">
        <div>
            ...
            ?>
<a href="{{route('user.package')}}" class=" text-blue-600 bg-blue-100 cursor-pointer py-2 px-2 outline-none rounded"> <i class="las la-arrow-circle-left"></i> Back to package</a>


              <form class="foma" id="foma" method="POST" action="{{route('payment')}}" >
                        @csrf
                        <input type="hidden" name="payment_method" value="{{request()->query('from_deposits') == '1' ? 'FROM_DEPOSITS' : ''}}"/>
                     <label id="am"> <input type="hidden" name="amount" id="amount" value="{{$amount}}"></label>
                         <label id="am1">
                            <input type='hidden' name='email' value='{{$email}}'>
                            <input type='hidden' name='package' id='amount' value='{{$package->name}}'>
                         </label>
