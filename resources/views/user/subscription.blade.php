            ...
            <div class="bg-white p-3 my-5 rounded shadow-md">
                     ...
                     <thead>
                        ...
                        <tbody>
                            ...
                            @foreach($transaction as $trx)
                                ...
                                @endphp
                            <tr>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->product}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->plan}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{formatIsoDate($data->start_date)}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{formatIsoDate($data->end_date)}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->user}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->code}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->package}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->token}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->current_token}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->price}}$</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->current_price}}$</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->poolcapital}}$</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->current_poolcapital}}$</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->period}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{formatIsoDate($data->purchase_date)}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->username}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->revenue_earned}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->revenue_type}}</th>
                                <th class="py-2 px-4  border-b border-gray-200 text-xs">{{$data->status}}</th>
                ...
                <!-- image -->
                      ...
                      <div class="text-center mt-4">
                        ...
                        <a href="{{route('user.buypackage')}}" class="bg-blue-700 focus:outline-none hover:bg-blue-700 py-1"> <i class="fa-solid fa-plus"></i> Subscribe Product</a>
