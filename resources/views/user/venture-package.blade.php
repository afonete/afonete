                            ...
                            <div class="ad-main-box mt-3 mb-3">
                                ...
                                <div class="ad-sub-box1 ">
                                    <div class="sub-box-1">
                                        ...
                                        <div class="ad-box bg-success"><a href="{{route('user.dashboard.activate')}}"
                                ...
                                <div class="ad-sub-box1 ">
                                    <div class="sub-box-1">
                                        <div class=" ad-box bg-success "><a class="nav-icon fas fa-gear"
                                                                            href="{{route('user.package.history')}}"><br>My
                                                package</a></div>
                                                ...
                                                <div class="row my-2">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6">
                                                        <div class="info-box main-upcoming">
                                                            <div class="upcoming ">
                                                                <div>
                                                                    <img src="{{asset('assets/a/img/upcoming.png')}}"
                                                                         alt="">
                                                                </div>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6">
                                                        ...
                                                        <div class="info-box mb-3  main-upcoming">
                                                            <div class="upcoming">
                                                                <div>
                                                                    <img src="{{asset('assets/a/img/booking.png')}}"
                                                                         alt="">
                                                                </div>
                                                                <div class="info-box-content text-center">
                                                                    <b>booking system</b>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6">
                                                        ...
                                                        <div class="info-box mb-3  main-upcoming">
                                                            <div class="upcoming">
                                                                <div>
                                                                    <img src="{{asset('assets/a/img/shopping.png')}}"
                                                                         alt="">
                                                                </div>
                                                                <div class="info-box-content text-center">
                                                                    <b>Market Place</b>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-6">
                                                        ...
                                                        <div class="info-box mb-3  main-upcoming">
                                                            <div class="upcoming">
                                                                <div>
                                                                    <img src="{{asset('assets/a/img/crypto.png')}}"
                                                                         alt="">
                                                                </div>
                                                                <div class="info-box-content text-center">
                                                                    <b>crypto loans </b>
