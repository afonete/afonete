...
<div class="row mt-4">
  ...
  <div class="card-body">
    <table class="table table-bordered table-striped text-center">
      ...
      <tbody>
         @foreach($all_referal as $refer)

         <tr>
            <td>{{$loop->iteration}}</td>
            <td>{{$refer->user->name}}</td>
            <td>{{$refer->side}}</td>
            <td>{{$refer->user->has_paid_package}}</td>
            <td>soon</td>
         </tr>
         @endforeach
      </tbody>
                            ...
                            <div class="card-body">
                                <div class="referral-link-container">
                                    ...
                                    <div class="input-group mb-3">
                                        @if($activated != 'standard')
                                            <input type="text" class="form-control" id="leftRefLink" 
                                                value="https://bifonex.com/register?referral={{$ref_code}}_L" readonly>
                                        @else
                                            <input type="text" class="form-control" value="https://bifonex.com/register?referral=*******" readonly>
                                        @endif
                                        <div class="input-group-append">
                            ...
                            <div class="card-body">
                                <div class="referral-link-container">
                                    ...
                                    <div class="input-group mb-3">
                                        @if($activated != 'standard')
                                            <input type="text" class="form-control" id="rightRefLink" 
                                                value="https://bifonex.com/register?referral={{$ref_code}}_R" readonly>
                                        @else
                                            <input type="text" class="form-control" value="https://bifonex.com/register?referral=*******" readonly>
                                        @endif
                                        <div class="input-group-append">
