...
<div class="dashboard-grid-container">
    ...
    <div class="alert alert-info mb-4 p-3 border-0 shadow-sm text-white" style="border-radius:12px; background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border-left: 5px solid #f59e0b !important;">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div class="d-flex align-items-center gap-3">
                <div class="p-2 rounded-circle bg-warning text-dark font-weight-bold d-flex align-items-center justify-content-center" style="width: 42px; height: 42px; font-size: 1.2rem;">
    ...
    <div class="row">
        {{-- Card 1: Account Status – UVP PORTFOLIO HAS PRIMARY VISIBILITY --}}
                    ...
                    <div class="dash-card-footer">
                        ...
                        @if(isset($mypackage) && $mypackage)
                            ...
                            @elseif(isset($daysgone))
                                <small style="opacity:.85;">Day {{ $daysgone }} / {{ $pkg_duration ?? 100 }}</small>
                            @endif
                        @elseif(isset($is_team_leader) && $is_team_leader)
            ...
            <div class="dash-card bg-grad-success text-white">
                <div class="card-body">
                    ...
                    <div class="dash-card-footer d-flex align-items-center justify-content-between">
                        <a href="{{ route('user.internal-exchange') }}" class="text-white font-weight-bold" style="text-decoration: underline;">
                            Internal Exchange <i class="fas fa-right-left ml-1"></i>
                        </a>
                        <a href="{{ route('user.dashboard.balance') }}" class="text-white font-weight-bold" style="text-decoration: underline;">
            ...
            @if($user->has_free_package == 'yes')
                <div class="dash-card bg-grad-warning text-white">
                    <div class="card-body">
                        ...
                        <div class="dash-card-footer">
                            <a href="{{ route('user.buypackage') }}" class="btn btn-sm btn-light btn-block font-weight-bold text-dark mt-2" style="border-radius: 6px;">
            ...
            <div class="dash-card bg-grad-warning text-white">
                <div class="card-body">
                    ...
                    <div class="dash-card-subtitle mt-1" style="font-size:0.8rem; opacity:.95; line-height: 1.6;">
                        <i class="fas fa-chart-line mr-1"></i> Daily yield rate: <strong>+${{ $daily_income_per_day }}/day</strong><br>
                        <small style="opacity:.85;">Accumulated across {{ $active_packages_count }} active {{ Str::plural('package', $active_packages_count) }}</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-4 mb-4">
            <div class="dash-card bg-grad-info text-white">
                <div class="card-body">
                    ...
                    <div class="dash-card-value" style="font-size: 1.8rem; font-weight: 900;">
                        ${{ number_format($trading_raw, 2) }}
                    </div>
                    <div class="dash-card-subtitle mt-1" style="font-size:0.8rem; opacity:.95; line-height: 1.6;">
                        <i class="fas fa-plus-circle mr-1"></i> Daily Trading Voucher rate: <strong>+${{ $daily_trading }}/day</strong><br>
        ...
        <div class="col-12 col-md-4 mb-4">
            <div class="dash-card bg-grad-success text-white">
                <div class="card-body">
                    ...
                    <div class="dash-card-value" style="font-size: 1.8rem; font-weight: 900;">
                        ${{ number_format($cashout_raw, 2) }}
                    </div>
                    <div class="dash-card-subtitle mt-1" style="font-size:0.8rem; opacity:.95; line-height: 1.6;">
                        <i class="fas fa-plus-circle mr-1"></i> Daily Cashout rate: <strong>+${{ $daily_cashout }}/day</strong><br>
                    ...
                    <div class="dash-card-footer d-flex justify-content-between align-items-center" style="border-top: 1px solid rgba(255, 255, 255, 0.15); padding-top: 10px; margin-top: 10px;">
                        ...
                        <a href="{{ route('user.dashboard.userwithdraw') }}" class="badge badge-light text-success px-2.5 py-1 font-weight-bold" style="border-radius:4px; text-decoration:none; font-size: 0.78rem;">
                            Withdraw Now →
                        </a>
                    </div>
                </div>
    ...
    <div class="card mb-4 border-0 shadow-sm" style="border-radius: 12px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: #ffffff;">
        <div class="card-body p-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3 pb-3" style="border-bottom: 1px solid rgba(255,255,255,0.15);">
                <div>
                    <span class="badge badge-warning text-dark font-weight-bold text-uppercase px-2 py-1 mb-1" style="border-radius: 4px; font-size: 0.7rem;">
                        <i class="fas fa-crown mr-1"></i> Team Leader Token Box
                    </span>
                    <h4 class="font-weight-bold mb-0 text-white" style="font-size: 1.3rem;">
                        Team Leader Token Portfolio
                    </h4>
                    <p class="text-light mb-0 small opacity-75">
                        Overview of all tokens held in your Team Leader account, including individual token wallets and total combined balance.
                    </p>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3 mb-4">
            <div class="dash-card border-left border-primary" style="border-left-width: 5px !important;">
                <div class="card-body">
                    <div class="dash-card-header">
                        <span class="dash-card-title text-primary font-weight-bold">Total Tokens</span>
         ...
         <div class="ref row">
            ...
            <div class="row2 col-md-3 mx-div zoom">
                 ...
                 <div class="subZoom row mt-1">
                    <div class="img col-2">
                        <div class="zoomImg">
                            <img src="{{asset('assets/a/img/zoom.png')}}" alt="Zoom">
                        </div>
                    </div>
                    <div class="col-10 zoom-content">
                        <div>
                            <span class="text-warning font-weight-bold" style="font-size:0.85rem;">{{ $activeZoomUser->topic }}</span><br>
                            <span class="font-weight-bold"><a href="{{ $activeZoomUser->zoom_link }}" target="_blank" rel="noopener noreferrer">CLICK HERE TO JOIN US <i class="fas fa-external-link-alt ml-1"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 520px;">
                     <div class="modal-content p-4 shadow-2xl border-0 rounded-2xl text-white" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border: 1px solid rgba(245, 158, 11, 0.4) !important; border-radius: 18px !important;">
                         ...
                         <div class="d-flex items-center justify-content-between gap-3 pt-3 border-top" style="border-top-color: rgba(255, 255, 255, 0.15) !important;">
                             ...
                             <a href="{{ route('user.buypackage') }}" class="btn btn-warning font-weight-bold text-dark px-4 py-2 flex-grow-1" style="border-radius: 8px; font-size: 12px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border: none;">
                                                     ...
                                                     <div class="row">
                                                         ...
                                                         <div class="col-6">
                                                             <div class="card border-0 shadow-sm text-center py-3" style="border-radius: 10px; border: 1px solid #f1f5f9 !important; background-color: #fcfcfd; margin-bottom: 0;">
                                                                 ...
                                                                 <h3 class="font-weight-bold text-info mb-1" id="left-amount" style="font-size: 1.2rem;">${{ number_format($left_earning ?? 0, 2) }}</h3>
                                                         ...
                                                         <div class="col-6">
                                                             <div class="card border-0 shadow-sm text-center py-3" style="border-radius: 10px; border: 1px solid #f1f5f9 !important; background-color: #fcfcfd; margin-bottom: 0;">
                                                                 <i class="fa fa-chart-line text-warning mb-2" style="font-size: 1.3rem;"></i>
                                                                 <h3 class="font-weight-bold text-info mb-1" id="right-amount" style="font-size: 1.2rem;">${{ number_format($right_earning ?? 0, 2) }}</h3>
