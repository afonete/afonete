...
<script src="https://cdn.tailwindcss.com"></script>
            ...
            <div class="my-2 mx-2">
                <ul class="flex flex-col md:flex-row md:space-x-5 md:space-y-0 space-y-4">
                    <li>
                        <a href="/user/user-wallet" class="font-medium text-lg hover:border-b-2 py-1 hover:text-orange-600 hover:border-orange-600">Wallet</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('commission')}}" class="font-medium text-lg hover:border-b-2 py-1 hover:text-orange-600 hover:border-orange-600">Commissions</a>
                    </li>
                    <li>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full mt-4">
                            ...
                            <tbody>
                                ...
                                @endphp
                                <tr>
                                    <td class="border-b px-4 py-2 text-green-600">{{$data->amount}} $</td>
                                    <td class="border-b px-4 py-2">{{$data->type}}</td>
                                    <td class="border-b px-4 py-2">{{$data->amount}} $</td>
                                    <td class="border-b px-4 py-2">{{$formattedDate}}</td>
                                    <td class="border-b px-4 py-2">{{$data->cash_25}} $</td>
                                    <td class="border-b px-4 py-2">{{$data->trading_75}} $</td>
                                    <td class="border-b px-4 py-2">{{$data->description}}</td>
