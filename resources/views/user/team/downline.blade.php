         ...
         <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-5">
           ...
           <div class="bg-slate-700 shadow-md rounded-lg p-4 self-start ">
            ...
            <div class=" flex items-center justify-between">
               <div>
                   <p class="text-4xl font-bold text-slate-300">{{$team_members}}</p>
                </div>
                <div class="mr-4">
           ...
           <div class="bg-white shadow-md rounded-lg p-4 self-start  ">
               ...
               <div class="flex items-center justify-between">
                   <div>
                       ...
                       <p class="text-4xl font-bold text-slate-600">{{$person_members}}</p>
                    </div>
                    <div class="mr-4">
           ...
           <div class="bg-blue-900 text-white shadow-md rounded-lg p-6  col-span-2 grid grid-cols-2 gap-2 items-center">
               ...
               <a href="{{route('referrals.free')}}" class="flex items-center gap-2 bg-gray-300 px-2 py-2 rounded-md self-center">
                     <div class=" ">
               ...
               <a href="{{route('referrals.paid')}}" class="flex items-center gap-2 bg-gray-300 px-2 py-2 rounded-md self-center">
                   <div class=" ">
                     <h3 class="text-lg font-semibold ">Click Here to</h3>
                     <p>Paid Referrals</p>
                   </div>
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div class="bg-white shadow-md rounded-lg flex items-center  py-2 px-2">
                    ...
                    <div>
                        ...
                        <p class="text-yellow-500 flex gap-2 py-2 items-center">Members: <span class="text-gray-600 ">{{$total_members}}</span></p>
                    </div>
              </div>
              ...
              <div class="bg-white shadow-md rounded-lg flex items-center  py-2 px-2">
                ...
                <div>
                    ...
                    <p class="text-yellow-500 flex gap-2 py-2 items-center">Members: <span class="text-gray-600 ">{{$left_team}}</span></p>
                </div>
          </div>
          ...
          <div class="bg-white shadow-md rounded-lg flex items-center  py-2 px-2">
            ...
            <div>
                ...
                <p class="text-yellow-500 flex gap-2 py-2 items-center">Members: <span class="text-gray-600 ">{{$right_team}}</span></p>
            </div>
      </div>
           ...
           <table class="w-full text-left">
             ...
             <tbody>
              ...
              <tr>
                ...
                <td class="py-2 px-4">
                    {{$member->has_free_package == 'yes'?'Not Acivated Yet':$member->has_paid_package}}

                </td>
                <td class="py-2 px-4">
                    {{$member->country}}
                </td>
                <td class="py-2 px-4">{{$member->updated_at}}</td>
                <td class="py-2 px-4">soon</td>
                <td class="py-2 px-4">{{$member->teamSide->name}}</td>
                <td class="py-2 px-4">{{$member->teamSide->side}}</td>
              </tr>
              @endforeach
              @foreach ($personM as $member )

              <tr>
                <td class="py-2 px-4"> {{$member->name}} </td>
                <td class="py-2 px-4">
                    {{($member->has_paid_package == 'no' || $member->has_paid_package == 'standard')?'Not Acivated Yet':$member->have_activation_code->created_at}}
                ...
                <td class="py-2 px-4">{{$member->updated_at}}</td>
                <td class="py-2 px-4">soon</td>
                <td class="py-2 px-4">{{$member->referrer->name}}</td>
                <td class="py-2 px-4">{{$member->teamSide->side}}</td>
              </tr>
              @endforeach
             </tbody>
