                ...
                <span class="text-orange-800 text-center font-medium">: Sponsor Link</span>
                  <div class="flex flex-col ">
                                        <div class="relative">
                                            ...
                                            <div class="flex">
                                                <input type="text" id="leftLink" value="{{ url('/register?position=left&sponsor=' . auth()->user()->username) }}" class="w-full px-2 py-1 h-8 border border-gray-300 rounded-l-md shadow-sm focus:ring-orange-500 focus:border-orange-500" readonly>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="flex">
                                                <input type="text" id="rightLink" value="{{ url('/register?position=right&sponsor=' . auth()->user()->username) }}" class="w-full px-2 py-1 h-8 border border-gray-300 rounded-l-md shadow-sm focus:ring-orange-500 focus:border-orange-500" readonly>
