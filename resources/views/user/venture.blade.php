 ...
 <div class="col-sm-10 col-lg-5 mx-md-3">
     <div>
         ...
         ?>
           ...
           <form class="foma" id="foma"method="POST" action="{{route('paymentventure')}}" >
                     @csrf
                  <label id="am">
                      <input type="hidden" name="amount" id="amount_to_invest" value="{{$venture->amount_invest}}">
                    </label>
                      <label id="am1">
                         <input type='hidden' name='email' value='{{$email}}'>
                         <input type='hidden' name='package'  value='{{$venture->venture}}'>
                      </label>

                      <span id="payment_area"></span>

                   <span style="background: #393d4a;color: red;text-transform:uppercase" class="p-2 rounded">
                    UVP &nbsp;&nbsp;{{$venture->amount_invest}} $
                    </span>
                   <div id="hideme">
