        ...
        <div class="container-fluid py-4 px-4">
            ...
            <div class="card shadow-sm border-0 mb-4" style="background:#1F2937; color:#fff; border-radius:10px;">
                <div class="card-header bg-dark text-white font-weight-bold d-flex justify-between align-items-center py-3">
                    ...
                    <a href="{{ route('investment-package') }}" class="btn btn-sm btn-outline-warning font-weight-bold">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('user.dashboard.validate') }}" method="POST" class="max-w-md mx-auto">
                        @csrf
            ...
            {{-- My Purchased Activation Codes Table --}}
            <div class="card shadow-sm border-0 mb-4" style="background:#1F2937; color:#fff; border-radius:10px;">
                <div class="card-header bg-dark text-white font-weight-bold py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge badge-info px-3 py-2 font-weight-bold">{{ count($myCodes ?? []) }} Total Codes</span>
                </div>
                <div class="card-body p-0">
                    @if(empty($myCodes) || count($myCodes) === 0)
                        <div class="text-center p-4 text-muted">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('investment-package') }}" class="btn btn-sm btn-primary font-weight-bold">
                                    ...
                                    @foreach($myCodes as $idx => $actCode)
                                        ...
                                        <tr class="border-bottom border-secondary">
                                            ...
                                            <td class="align-middle">
                                                <code class="text-warning font-weight-bold bg-black px-2 py-1 rounded" id="user-code-{{ $actCode->id }}">{{ $actCode->code }}</code>
                                                <button type="button" class="btn btn-xs btn-outline-warning ml-2 font-weight-bold" onclick="copyCodeText('user-code-{{ $actCode->id }}')">
