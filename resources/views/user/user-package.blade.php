    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content" style="background: linear-gradient(190deg, #2ecd71 60%, #27ae60 40.1%); color: black; width: 80%; margin: 0 auto;">
            <div class="flex justify-content-between mb-4 fc_container">
                <a href="{{ route('user.venture') }}"><button type="button" class="btn btn-outline-info text-white btn-primary"> Back</button></a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                ...
                                                <center>
                                                    FC VIP {{$package->price}}$

                                                </center>
                                                <div class="text-center mt-3">
                                                    <a href="{{route('fc',$package->id)}}"><button class="btn btn-primary" value="100"> BUY NOW</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="text-center mt-3">
                                                <a href="{{route("user.payment.deposits")}}" class="btn btn-primary d-block w-100"  value="200" >DEPOSIT</a>
