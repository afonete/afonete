 ...
 -->
    ...
    <div class="flex space-x-4 py-3">
            <span @click="toggleMethod('Bitcoin')" 
                ...
                class="text-white rounded transition relative">
                   <i x-show="paymentMethod === 'Bitcoin'" class="las la-check bg-purple-500 rounded-full p-1 left-0 top-2 absolute border"></i>
                    <img src="{{asset('assets/image/py.jpeg')}}" class="w-24 rounded-sm" />
              </span>
            <span @click="toggleMethod('Advcash')" 
                ...
                <img src="{{asset('assets/image/adv.jpeg')}}" class="w-24 rounded-sm" /> 
            </span>
            <span @click="toggleMethod('Perfect Money')" 
                ...
                <img src="{{asset('assets/image/p1.jpeg')}}" class="w-24 rounded-sm" />
            </span>
        </div>
        ...
        <form action="{{route('user.payment.savedeposits')}}" method="post" action="{{route('user.payment.savedeposits')}}" x-show="showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-40" 
         id="form">
          @csrf
          @method('POST')
