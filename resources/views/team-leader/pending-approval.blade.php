                ...
                <div class="profile-card">
                    <div class="text-center">
                        ...
                        <div class="profile-info">
                            <p class="mb-2"><i class="fas fa-user me-2"></i>{{$name}}</p>
                        </div>
                        <div class="profile-info">
                            <p class="mb-2"><i class="fas fa-envelope me-2"></i>{{$email}}</p>
                        </div>
                        <div class="profile-info">
                            <p class="mb-2"><i class="fas fa-id-badge me-2"></i>{{$username}}</p>
                        </div>
                        <div class="profile-info">
                            <p class="mb-2"><i class="fas fa-phone me-2"></i>{{$phone}}</p>
                        </div>
                        <div class="profile-info">
                            <p class="mb-2"><i class="fas fa-globe me-2"></i>{{$country}}</p>
                        </div>
                    </div>
                </div>
