...
<head>
    ...
    <title>Team Leader Login | {{ env('APP_NAME') }}</title>
...
<body>
    ...
    <div class="login-card">
        ...
        <div class="p-4">
            ...
            <form action="{{ route('team-leader.login.post') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="login" required value="{{ old('login') }}" class="form-control" placeholder="Enter username or email">
                    </div>
                </div>
            ...
            <div class="text-center mt-4 pt-3 border-t text-xs text-muted">
                ...
                <a href="{{ route('team.leader') }}" class="text-primary font-bold decoration-none underline block mt-1">
