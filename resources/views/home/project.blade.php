                ...
                <div class="col-lg-6">
                    ...
                    <div class="ap-title">
                        ...
                        <p class="my-4"  style="color: #707079;">
                            <span class="stage"> STAGE 2 –</span>has three phrase; {{ strtoupper(env('APP_NAME')) }} will LAUNCH ,fomo which way generate money through (watch video, complete tasks, 
                            click views ,download app, survey and online gaming play ) and open for all users/ partners process phase1 . process phase2. {{ strtoupper(env('APP_NAME')) }}  full operational 
                         ...
                         {{ strtoupper(env('APP_NAME')) }}	open  full operated and activated Future AI BOT, E business, Future booking.

                        </p>
                        <p class="my-4"  style="color: #707079;">
                           <span class="stage"> STAGE 3 –</span> – {{ strtoupper(env('APP_NAME')) }}  will LAUNCH, and starting to activate  flexible staking options,  Future Chat , distributors coins
                           And allowed distributors/ agent .

                          </p>
                          <p class="my-4"  style="color: #707079;">
                          <span class="stage"> STAGE 4 –</span> {{ strtoupper(env('APP_NAME')) }} will LAUNCH, crypto loan, money transfer, exchange and full all feature option.
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ap-title">
                        ...
                        <p class="paragraph">
                            THIS IS EXCLUSIVE ACCESS TO {{ strtoupper(env('APP_NAME')) }} - {{ strtoupper(env('APP_NAME')) }} reserves 50 people for the first 100 members
...
<section class="my-5">
    <div class="main_container">
        <div>
                    ...
                    <div class="ap-title">
                        <h3>Amazing {{ strtoupper(env('APP_NAME')) }} & innovative products</h3>
                        <p style="color: #707079;">
                            {{ strtoupper(env('APP_NAME')) }} offers a wide range of products and services. Some are already available; others are
