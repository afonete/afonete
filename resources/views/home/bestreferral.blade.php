...
@include('home.include.leadersnav')
    ...
    <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="md:w-[50%] md:mx-10 mx-5 flex justify-center">
            <img src="{{asset('image/bgmo.png')}}" alt="Ambassador" class="h-auto w-96 md:m-20 m-10 bounce-infinite">
        </div>
...
<div>
    ...
    Whether you are an investor or a {{(env('APP_NAME')) }} enthusiast, you can invite people with your unique referral
    link through the {{(env('APP_NAME')) }} Referral Program and earn unlimited commission.
    </p>
</div>

<div>
    <h1 class="text-3xl font-bold my-3 text-blue-900
    " >WHY START WITH  {{ strtoupper(env('APP_NAME')) }}  REFERRAL  PROGRAMS</h1>
    <p class="text-gray-950 text-md">
    {{(env('APP_NAME')) }} Referral Program is not an ordinary program. It allows you to earn in up to 20 Levels within your referral network  Lifetime. 
    The Referral Program helps you, as well as your referrals, earn higher income and add value to your network.
    <br>
    Let's grow the personal crypto community together with the {{(env('APP_NAME')) }} Referral Program!
    </p>
</div>

<div>
    <h1 class="text-3xl font-bold my-3 text-blue-900
    " >WHAT ARE  {{ strtoupper(env('APP_NAME')) }} REFERRALS BONUSES? </h1>
    <p class="text-gray-950 text-md">
    A {{(env('APP_NAME')) }}  bonus is exactly what it sounds like: you get rewarded for referring your friends to {{(env('APP_NAME')) }} site. It's a very easy way
     to add hundreds  thousands  of dollars to your wallet. There's no limit to how many referrals you can introduce to {{(env('APP_NAME')) }}. Earn as much as you want.
    </p>
</div>

<div>
    <h1 class="text-3xl font-bold my-3 text-blue-900
    " > {{ strtoupper(env('APP_NAME')) }} REFERRAL PROGRAM HIGHLIGHTS</h1>
    <p class="text-gray-950 text-md">
        Start working with {{(env('APP_NAME')) }} that can provide everything you need to generate your personal network.
        Enjoying the best slice on the financial market together with the best referral program in the world.
