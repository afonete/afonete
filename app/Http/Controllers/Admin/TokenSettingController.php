...
class TokenSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'initial_supply'        => 'required|numeric|min:0',
            'initial_liquidity'     => 'required|numeric|min:0',
            'staking_yield_1_year'  => 'nullable|numeric|min:0',
            'staking_yield_2_year'  => 'nullable|numeric|min:0',
            'staking_yield_3_year'  => 'nullable|numeric|min:0',
            'staking_yield_4_year'  => 'nullable|numeric|min:0',
            'staking_yield_5_year'  => 'nullable|numeric|min:0',
        ]);
        ...
        $data = [
            ...
            'staking_yield_1_year'  => $request->staking_yield_1_year ?? ($current->staking_yield_1_year ?? 10.00),
            'staking_yield_2_year'  => $request->staking_yield_2_year ?? ($current->staking_yield_2_year ?? 25.00),
            'staking_yield_3_year'  => $request->staking_yield_3_year ?? ($current->staking_yield_3_year ?? 45.00),
            'staking_yield_4_year'  => $request->staking_yield_4_year ?? ($current->staking_yield_4_year ?? 70.00),
            'staking_yield_5_year'  => $request->staking_yield_5_year ?? ($current->staking_yield_5_year ?? 100.00),
            'updated_by'            => Auth::id(),
        ];
        ...
        return redirect()->route('admin.token-settings')
            ->with('message', 'Token prices and Escrow Staking yields updated successfully.');
    }
}
